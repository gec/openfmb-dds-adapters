...
public class ActivePowerTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::ActivePower";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ActivePowerTypeSupport _singleton
    = new ActivePowerTypeSupport();
    ...
    */
    public static ActivePowerTypeSupport get_instance() {
        return _singleton;
    }

    public static ActivePowerTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ActivePowerTypeCode.VALUE;
    }

    public Object create_data() {
        return ActivePower.create();
    }
    ...
    * <code>this</code> is not a <code>ActivePower</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ActivePower typedDst = (ActivePower) destination;
        ActivePower typedSrc = (ActivePower) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ActivePower typedSrc = (ActivePower) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ActivePower typedDst = (ActivePower) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ActivePower typedDst = (ActivePower) sample;
    ...
    protected ActivePowerTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ActivePowerTypeCode.VALUE,ActivePower.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ActivePowerTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ActivePowerTypeCode.VALUE,ActivePower.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
