...
public class ReadingTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::Reading";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReadingTypeSupport _singleton
    = new ReadingTypeSupport();
    ...
    */
    public static ReadingTypeSupport get_instance() {
        return _singleton;
    }

    public static ReadingTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReadingTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Reading</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Reading typedDst = (Reading) destination;
        Reading typedSrc = (Reading) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Reading typedSrc = (Reading) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.readingType);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.timePeriod);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeTypeSupport.get_instance().serialize(endpoint_data, typedSrc.readingType, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().serialize(endpoint_data, typedSrc.timePeriod, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.readingType = (org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingType)org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.readingType, src, false, true, endpoint_plugin_qos);     
                typedDst.timePeriod = (org.openfmb.model.dds.rti.openfmb.commonmodule.DateTimeInterval)org.openfmb.model.dds.rti.openfmb.commonmodule.DateTimeIntervalTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.timePeriod, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Reading typedDst = (Reading) sample;
    ...
    protected ReadingTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReadingTypeCode.VALUE,Reading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReadingTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReadingTypeCode.VALUE,Reading.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
