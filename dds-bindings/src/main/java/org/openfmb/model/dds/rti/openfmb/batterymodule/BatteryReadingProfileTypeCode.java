...
public class  BatteryReadingProfileTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("readings", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.openfmb.batterymodule.SequenceOfBatteryReadingsTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("openfmb::batterymodule::BatteryReadingProfile",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
