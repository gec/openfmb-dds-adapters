...
public class SecurityEventProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::securitymodule::SecurityEventProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SecurityEventProfileTypeSupport _singleton
    = new SecurityEventProfileTypeSupport();
    ...
    */
    public static SecurityEventProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static SecurityEventProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SecurityEventProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return SecurityEventProfile.create();
    }
    ...
    public Class get_type() {
        return SecurityEventProfile.class;
    }
    ...
    * <code>this</code> is not a <code>SecurityEventProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SecurityEventProfile typedDst = (SecurityEventProfile) destination;
        SecurityEventProfile typedSrc = (SecurityEventProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SecurityEventProfile typedSrc = (SecurityEventProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    */
    ...
    int mask) {
        return new SecurityEventProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SecurityEventProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected SecurityEventProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SecurityEventProfileTypeCode.VALUE,SecurityEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SecurityEventProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SecurityEventProfileTypeCode.VALUE,SecurityEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
