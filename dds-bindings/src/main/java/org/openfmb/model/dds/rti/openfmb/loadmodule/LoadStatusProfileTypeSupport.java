...
public class LoadStatusProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::LoadStatusProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadStatusProfileTypeSupport _singleton
    = new LoadStatusProfileTypeSupport();
    ...
    */
    public static LoadStatusProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadStatusProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadStatusProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadStatusProfile.create();
    }
    ...
    public Class get_type() {
        return LoadStatusProfile.class;
    }
    ...
    * <code>this</code> is not a <code>LoadStatusProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadStatusProfile typedDst = (LoadStatusProfile) destination;
        LoadStatusProfile typedSrc = (LoadStatusProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.EnergyConsumerTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.EnergyConsumerTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LoadStatusProfile typedSrc = (LoadStatusProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.EnergyConsumerTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.loadmodule.EnergyConsumerTypeSupport.get_instance().serialize(endpoint_data, typedSrc.energyConsumer, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadStatusProfile typedDst = (LoadStatusProfile) dst;
            typedDst.clear();      
            try{
                typedDst.logicalDeviceID = src.readString((255));
                typedDst.timestamp = src.readLong();
                typedDst.energyConsumer = (org.openfmb.model.dds.rti.openfmb.loadmodule.EnergyConsumer)org.openfmb.model.dds.rti.openfmb.loadmodule.EnergyConsumerTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.energyConsumer, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.loadmodule.EnergyConsumerTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadStatusProfile typedDst = (LoadStatusProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        LoadStatusProfile typedDst
        = (LoadStatusProfile) instance;
        LoadStatusProfile typedSrc
        = (LoadStatusProfile) key;
    ...
    */
    ...
    int mask) {
        return new LoadStatusProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LoadStatusProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected LoadStatusProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,LoadStatusProfileTypeCode.VALUE,LoadStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadStatusProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadStatusProfileTypeCode.VALUE,LoadStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
