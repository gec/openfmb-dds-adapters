...
* SequenceOfBatterySystemControlSetPoints
*/

public class SequenceOfBatterySystemControlSetPointsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::SequenceOfBatterySystemControlSetPoints";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfBatterySystemControlSetPointsTypeSupport _singleton
    = new SequenceOfBatterySystemControlSetPointsTypeSupport();
    ...
    */
    public static SequenceOfBatterySystemControlSetPointsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfBatterySystemControlSetPointsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfBatterySystemControlSetPointsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfBatterySystemControlSetPoints.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfBatterySystemControlSetPoints();
    }
    ...
    public Class get_type() {
        return SequenceOfBatterySystemControlSetPoints.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfBatterySystemControlSetPoints</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfBatterySystemControlSetPoints typedDst = (SequenceOfBatterySystemControlSetPoints) destination;
        SequenceOfBatterySystemControlSetPoints typedSrc = (SequenceOfBatterySystemControlSetPoints) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.batterymodule.MaxLengthBatterySystemControlSetPoints.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfBatterySystemControlSetPoints typedSrc = (SequenceOfBatterySystemControlSetPoints) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.batterymodule.MaxLengthBatterySystemControlSetPoints.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfBatterySystemControlSetPoints typedDst = (SequenceOfBatterySystemControlSetPoints) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.batterymodule.MaxLengthBatterySystemControlSetPoints.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfBatterySystemControlSetPoints typedDst = (SequenceOfBatterySystemControlSetPoints) sample;
    ...
    protected SequenceOfBatterySystemControlSetPointsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfBatterySystemControlSetPointsTypeCode.VALUE,SequenceOfBatterySystemControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfBatterySystemControlSetPointsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfBatterySystemControlSetPointsTypeCode.VALUE,SequenceOfBatterySystemControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
