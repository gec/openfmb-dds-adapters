...
public class BatteryEventProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::BatteryEventProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryEventProfileTypeSupport _singleton
    = new BatteryEventProfileTypeSupport();
    ...
    */
    public static BatteryEventProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryEventProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryEventProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryEventProfile.create();
    }
    ...
    public Class get_type() {
        return BatteryEventProfile.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryEventProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryEventProfile typedDst = (BatteryEventProfile) destination;
        BatteryEventProfile typedSrc = (BatteryEventProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.BatteryStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.BatteryStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryEventProfile typedSrc = (BatteryEventProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.BatteryStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.batteryStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.batterymodule.BatteryStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.batteryStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryEventProfile typedDst = (BatteryEventProfile) dst;
            typedDst.clear();      
            try{
                typedDst.logicalDeviceID = src.readString((255));
                typedDst.timestamp = src.readLong();
                typedDst.batteryStatus = (org.openfmb.model.dds.rti.openfmb.batterymodule.BatteryStatus)org.openfmb.model.dds.rti.openfmb.batterymodule.BatteryStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.batteryStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.batterymodule.BatteryStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryEventProfile typedDst = (BatteryEventProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BatteryEventProfile typedDst
        = (BatteryEventProfile) instance;
        BatteryEventProfile typedSrc
        = (BatteryEventProfile) key;
    ...
    */
    ...
    int mask) {
        return new BatteryEventProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryEventProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryEventProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BatteryEventProfileTypeCode.VALUE,BatteryEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryEventProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryEventProfileTypeCode.VALUE,BatteryEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
