...
public class SwitchStatusKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::SwitchStatusKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SwitchStatusKindTypeSupport _singleton
    = new SwitchStatusKindTypeSupport();
    ...
    */
    public static SwitchStatusKindTypeSupport get_instance() {
        return _singleton;
    }

    public static SwitchStatusKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SwitchStatusKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SwitchStatusKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        SwitchStatusKind typedSrc = (SwitchStatusKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = SwitchStatusKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected SwitchStatusKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SwitchStatusKindTypeCode.VALUE,SwitchStatusKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
