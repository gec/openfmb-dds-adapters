...
public class SolarCapabilityTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarCapability";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarCapabilityTypeSupport _singleton
    = new SolarCapabilityTypeSupport();
    ...
    */
    public static SolarCapabilityTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarCapabilityTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarCapabilityTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarCapability.create();
    }
    ...
    * <code>this</code> is not a <code>SolarCapability</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarCapability typedDst = (SolarCapability) destination;
        SolarCapability typedSrc = (SolarCapability) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarCapability typedSrc = (SolarCapability) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.qualityFlag );
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.ahrRtg);

            dst.writeString(typedSrc.qualityFlag,(255));

            dst.writeLong(typedSrc.timestamp);

            dst.writeFloat(typedSrc.voltage);

            dst.writeFloat(typedSrc.wRtgMaxVal);

            dst.writeFloat(typedSrc.wRtgMinVal);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarCapability typedDst = (SolarCapability) dst;
            typedDst.clear();      
            try{
                typedDst.ahrRtg = src.readFloat();
                typedDst.qualityFlag = src.readString((255));
                typedDst.timestamp = src.readLong();
                typedDst.voltage = src.readFloat();
                typedDst.wRtgMaxVal = src.readFloat();
                typedDst.wRtgMinVal = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarCapability typedDst = (SolarCapability) sample;
    ...
    protected SolarCapabilityTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarCapabilityTypeCode.VALUE,SolarCapability.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarCapabilityTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarCapabilityTypeCode.VALUE,SolarCapability.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
