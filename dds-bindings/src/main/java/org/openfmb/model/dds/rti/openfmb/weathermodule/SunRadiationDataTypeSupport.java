...
public class SunRadiationDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::SunRadiationData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SunRadiationDataTypeSupport _singleton
    = new SunRadiationDataTypeSupport();
    ...
    */
    public static SunRadiationDataTypeSupport get_instance() {
        return _singleton;
    }

    public static SunRadiationDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SunRadiationDataTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SunRadiationData</code>
    * type.
    */
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SunRadiationData typedDst = (SunRadiationData) sample;
    ...
    protected SunRadiationDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SunRadiationDataTypeCode.VALUE,SunRadiationData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SunRadiationDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SunRadiationDataTypeCode.VALUE,SunRadiationData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
