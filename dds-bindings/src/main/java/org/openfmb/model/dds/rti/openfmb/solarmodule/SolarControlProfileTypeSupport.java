...
public class SolarControlProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarControlProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarControlProfileTypeSupport _singleton
    = new SolarControlProfileTypeSupport();
    ...
    */
    public static SolarControlProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarControlProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarControlProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarControlProfile.create();
    }
    ...
    public Class get_type() {
        return SolarControlProfile.class;
    }
    ...
    * <code>this</code> is not a <code>SolarControlProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarControlProfile typedDst = (SolarControlProfile) destination;
        SolarControlProfile typedSrc = (SolarControlProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SolarControlTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SolarControlTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarControlProfile typedSrc = (SolarControlProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SolarControlTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.solarControl);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.solarmodule.SolarControlTypeSupport.get_instance().serialize(endpoint_data, typedSrc.solarControl, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarControlProfile typedDst = (SolarControlProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.solarControl = (org.openfmb.model.dds.rti.openfmb.solarmodule.SolarControl)org.openfmb.model.dds.rti.openfmb.solarmodule.SolarControlTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.solarControl, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.solarmodule.SolarControlTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarControlProfile typedDst = (SolarControlProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarControlProfile typedDst
        = (SolarControlProfile) instance;
        SolarControlProfile typedSrc
        = (SolarControlProfile) key;
    ...
    */
    ...
    int mask) {
        return new SolarControlProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarControlProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarControlProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarControlProfileTypeCode.VALUE,SolarControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarControlProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarControlProfileTypeCode.VALUE,SolarControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
