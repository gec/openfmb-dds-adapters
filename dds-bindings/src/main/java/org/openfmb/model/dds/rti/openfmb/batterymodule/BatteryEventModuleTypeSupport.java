...
public class BatteryEventModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::BatteryEventModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryEventModuleTypeSupport _singleton
    = new BatteryEventModuleTypeSupport();
    ...
    */
    public static BatteryEventModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryEventModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryEventModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryEventModule.create();
    }
    ...
    public Class get_type() {
        return BatteryEventModule.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryEventModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryEventModule typedDst = (BatteryEventModule) destination;
        BatteryEventModule typedSrc = (BatteryEventModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryEventModule typedSrc = (BatteryEventModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryEventModule typedDst = (BatteryEventModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryEventModule typedDst = (BatteryEventModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BatteryEventModule typedDst
        = (BatteryEventModule) instance;
        BatteryEventModule typedSrc
        = (BatteryEventModule) key;
    ...
    */
    ...
    int mask) {
        return new BatteryEventModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryEventModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryEventModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BatteryEventModuleTypeCode.VALUE,BatteryEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryEventModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryEventModuleTypeCode.VALUE,BatteryEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
