...
public class RecloserReadingModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::RecloserReadingModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserReadingModuleTypeSupport _singleton
    = new RecloserReadingModuleTypeSupport();
    ...
    */
    public static RecloserReadingModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserReadingModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserReadingModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserReadingModule.create();
    }
    ...
    public Object create_key() {
        return new RecloserReadingModule();
    }
    ...
    public Class get_type() {
        return RecloserReadingModule.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserReadingModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserReadingModule typedDst = (RecloserReadingModule) destination;
        RecloserReadingModule typedSrc = (RecloserReadingModule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserReadingsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserReadingsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RecloserReadingModule typedSrc = (RecloserReadingModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.recloser);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserReadingsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserTypeSupport.get_instance().serialize(endpoint_data, typedSrc.recloser, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserReadingsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.readings, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserReadingModule typedDst = (RecloserReadingModule) dst;
            typedDst.clear();      
            try{
                typedDst.logicalDeviceID = src.readString((255));
                typedDst.timestamp = src.readLong();
                typedDst.recloser = (org.openfmb.model.dds.rti.openfmb.reclosermodule.Recloser)org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.recloser, src, false, true, endpoint_plugin_qos);     
                typedDst.readings = (org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserReadings)org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserReadingsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.readings, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserReadingsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserReadingModule typedDst = (RecloserReadingModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RecloserReadingModule typedDst
        = (RecloserReadingModule) instance;
        RecloserReadingModule typedSrc
        = (RecloserReadingModule) key;
    ...
    */
    ...
    int mask) {
        return new RecloserReadingModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RecloserReadingModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected RecloserReadingModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RecloserReadingModuleTypeCode.VALUE,RecloserReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserReadingModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserReadingModuleTypeCode.VALUE,RecloserReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
