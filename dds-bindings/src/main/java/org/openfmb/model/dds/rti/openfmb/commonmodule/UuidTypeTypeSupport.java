...
public class UuidTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::UuidType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UuidTypeTypeSupport _singleton
    = new UuidTypeTypeSupport();
    ...
    */
    public static UuidTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static UuidTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UuidTypeTypeCode.VALUE;
    }

    public Object create_data() {
        return UuidType.create();
    }
    ...
    * <code>this</code> is not a <code>UuidType</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        UuidType typedDst = (UuidType) destination;
        UuidType typedSrc = (UuidType) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        UuidType typedSrc = (UuidType) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.userData,(255));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            UuidType typedDst = (UuidType) dst;
            typedDst.userData = src.readString((255));
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            UuidType typedDst = (UuidType) sample;
    ...
    protected UuidTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UuidTypeTypeCode.VALUE,UuidType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected UuidTypeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,UuidTypeTypeCode.VALUE,UuidType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
