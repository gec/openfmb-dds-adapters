...
public class GeneratingUnitTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GeneratingUnit";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GeneratingUnitTypeSupport _singleton
    = new GeneratingUnitTypeSupport();
    ...
    */
    public static GeneratingUnitTypeSupport get_instance() {
        return _singleton;
    }

    public static GeneratingUnitTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GeneratingUnitTypeCode.VALUE;
    }

    public Object create_data() {
        return GeneratingUnit.create();
    }
    ...
    * <code>this</code> is not a <code>GeneratingUnit</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GeneratingUnit typedDst = (GeneratingUnit) destination;
        GeneratingUnit typedSrc = (GeneratingUnit) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GeneratingUnit typedSrc = (GeneratingUnit) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GeneratingUnit typedDst = (GeneratingUnit) sample;
    ...
    protected GeneratingUnitTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GeneratingUnitTypeCode.VALUE,GeneratingUnit.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GeneratingUnitTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GeneratingUnitTypeCode.VALUE,GeneratingUnit.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
