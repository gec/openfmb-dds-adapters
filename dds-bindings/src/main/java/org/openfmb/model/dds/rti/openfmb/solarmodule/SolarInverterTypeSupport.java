...
public class SolarInverterTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarInverter";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarInverterTypeSupport _singleton
    = new SolarInverterTypeSupport();
    ...
    */
    public static SolarInverterTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarInverterTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarInverterTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarInverter.create();
    }
    ...
    * <code>this</code> is not a <code>SolarInverter</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarInverter typedDst = (SolarInverter) destination;
        SolarInverter typedSrc = (SolarInverter) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarInverter typedSrc = (SolarInverter) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarInverter typedDst = (SolarInverter) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarInverter typedDst = (SolarInverter) sample;
    ...
    protected SolarInverterTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarInverterTypeCode.VALUE,SolarInverter.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarInverterTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarInverterTypeCode.VALUE,SolarInverter.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
