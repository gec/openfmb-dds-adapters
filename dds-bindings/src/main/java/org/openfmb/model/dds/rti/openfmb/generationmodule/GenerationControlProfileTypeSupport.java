...
public class GenerationControlProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationControlProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationControlProfileTypeSupport _singleton
    = new GenerationControlProfileTypeSupport();
    ...
    */
    public static GenerationControlProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationControlProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationControlProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationControlProfile.create();
    }
    ...
    public Class get_type() {
        return GenerationControlProfile.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationControlProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationControlProfile typedDst = (GenerationControlProfile) destination;
        GenerationControlProfile typedSrc = (GenerationControlProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationControlProfile typedSrc = (GenerationControlProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationControlProfile typedDst = (GenerationControlProfile) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationControlProfile typedDst = (GenerationControlProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationControlProfile typedDst
        = (GenerationControlProfile) instance;
        GenerationControlProfile typedSrc
        = (GenerationControlProfile) key;
    ...
    */
    ...
    int mask) {
        return new GenerationControlProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationControlProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationControlProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationControlProfileTypeCode.VALUE,GenerationControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationControlProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationControlProfileTypeCode.VALUE,GenerationControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
