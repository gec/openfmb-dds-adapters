...
* GenerationForecastModule
*/

public class GenerationForecastModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationForecastModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationForecastModuleTypeSupport _singleton
    = new GenerationForecastModuleTypeSupport();
    ...
    */
    public static GenerationForecastModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationForecastModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationForecastModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationForecastModule.create();
    }
    ...
    public Object create_key() {
        return new GenerationForecastModule();
    }
    ...
    public Class get_type() {
        return GenerationForecastModule.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationForecastModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationForecastModule typedDst = (GenerationForecastModule) destination;
        GenerationForecastModule typedSrc = (GenerationForecastModule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ForecastScheduleTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ForecastScheduleTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationForecastModule typedSrc = (GenerationForecastModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ForecastScheduleTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ForecastScheduleTypeSupport.get_instance().serialize(endpoint_data, typedSrc.forecastSchedule, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationForecastModule typedDst = (GenerationForecastModule) dst;
            typedDst.clear();      
            try{
                typedDst.logicalDeviceID = src.readString((255));
                typedDst.timestamp = src.readLong();
                typedDst.forecastSchedule = (org.openfmb.model.dds.rti.openfmb.commonmodule.ForecastSchedule)org.openfmb.model.dds.rti.openfmb.commonmodule.ForecastScheduleTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.forecastSchedule, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ForecastScheduleTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationForecastModule typedDst = (GenerationForecastModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationForecastModule typedDst
        = (GenerationForecastModule) instance;
        GenerationForecastModule typedSrc
        = (GenerationForecastModule) key;
    ...
    */
    ...
    int mask) {
        return new GenerationForecastModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationForecastModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationForecastModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationForecastModuleTypeCode.VALUE,GenerationForecastModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationForecastModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationForecastModuleTypeCode.VALUE,GenerationForecastModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
