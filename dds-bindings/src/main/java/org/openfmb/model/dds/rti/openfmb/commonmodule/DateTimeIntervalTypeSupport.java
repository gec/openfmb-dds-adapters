...
public class DateTimeIntervalTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::DateTimeInterval";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final DateTimeIntervalTypeSupport _singleton
    = new DateTimeIntervalTypeSupport();
    ...
    */
    public static DateTimeIntervalTypeSupport get_instance() {
        return _singleton;
    }

    public static DateTimeIntervalTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return DateTimeIntervalTypeCode.VALUE;
    }

    public Object create_data() {
        return DateTimeInterval.create();
    }
    ...
    * <code>this</code> is not a <code>DateTimeInterval</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        DateTimeInterval typedDst = (DateTimeInterval) destination;
        DateTimeInterval typedSrc = (DateTimeInterval) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        DateTimeInterval typedSrc = (DateTimeInterval) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            DateTimeInterval typedDst = (DateTimeInterval) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            DateTimeInterval typedDst = (DateTimeInterval) sample;
    ...
    protected DateTimeIntervalTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,DateTimeIntervalTypeCode.VALUE,DateTimeInterval.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected DateTimeIntervalTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,DateTimeIntervalTypeCode.VALUE,DateTimeInterval.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
