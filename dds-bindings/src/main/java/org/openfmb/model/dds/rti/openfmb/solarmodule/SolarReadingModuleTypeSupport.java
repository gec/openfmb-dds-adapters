...
public class SolarReadingModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarReadingModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarReadingModuleTypeSupport _singleton
    = new SolarReadingModuleTypeSupport();
    ...
    */
    public static SolarReadingModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarReadingModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarReadingModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarReadingModule.create();
    }
    ...
    public Class get_type() {
        return SolarReadingModule.class;
    }
    ...
    * <code>this</code> is not a <code>SolarReadingModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarReadingModule typedDst = (SolarReadingModule) destination;
        SolarReadingModule typedSrc = (SolarReadingModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarReadingModule typedSrc = (SolarReadingModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarReadingModule typedDst = (SolarReadingModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarReadingModule typedDst = (SolarReadingModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarReadingModule typedDst
        = (SolarReadingModule) instance;
        SolarReadingModule typedSrc
        = (SolarReadingModule) key;
    ...
    */
    ...
    int mask) {
        return new SolarReadingModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarReadingModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarReadingModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarReadingModuleTypeCode.VALUE,SolarReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarReadingModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarReadingModuleTypeCode.VALUE,SolarReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
