...
/**
* A sequence of CurveStyleKind instances.
*/
public final class CurveStyleKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CurveStyleKindSeq() {
        super(CurveStyleKind.class);
    }

    public CurveStyleKindSeq (int initialMaximum) {
        super(CurveStyleKind.class, initialMaximum);
    }

    public CurveStyleKindSeq (Collection elements) {
        super(CurveStyleKind.class, elements);
    }
