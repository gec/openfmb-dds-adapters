...
/**
* A sequence of MarketRun instances.
*/
public final class MarketRunSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MarketRunSeq() {
        super(MarketRun.class);
    }

    public MarketRunSeq (int initialMaximum) {
        super(MarketRun.class, initialMaximum);
    }

    public MarketRunSeq (Collection elements) {
        super(MarketRun.class, elements);
    }
