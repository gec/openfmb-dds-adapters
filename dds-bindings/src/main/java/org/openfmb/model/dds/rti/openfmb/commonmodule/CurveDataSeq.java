...
/**
* A sequence of CurveData instances.
*/
public final class CurveDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CurveDataSeq() {
        super(CurveData.class);
    }

    public CurveDataSeq (int initialMaximum) {
        super(CurveData.class, initialMaximum);
    }

    public CurveDataSeq (Collection elements) {
        super(CurveData.class, elements);
    }
