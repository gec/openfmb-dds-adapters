...
public class PhaseCodeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::phasecode::PhaseCodeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PhaseCodeKindTypeSupport _singleton
    = new PhaseCodeKindTypeSupport();
    ...
    */
    public static PhaseCodeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static PhaseCodeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PhaseCodeKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>PhaseCodeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        PhaseCodeKind typedSrc = (PhaseCodeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = PhaseCodeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected PhaseCodeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PhaseCodeKindTypeCode.VALUE,PhaseCodeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
