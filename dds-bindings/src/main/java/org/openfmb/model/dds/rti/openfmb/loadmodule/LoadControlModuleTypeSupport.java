...
public class LoadControlModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::LoadControlModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadControlModuleTypeSupport _singleton
    = new LoadControlModuleTypeSupport();
    ...
    */
    public static LoadControlModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadControlModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadControlModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadControlModule.create();
    }
    ...
    public Class get_type() {
        return LoadControlModule.class;
    }
    ...
    * <code>this</code> is not a <code>LoadControlModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadControlModule typedDst = (LoadControlModule) destination;
        LoadControlModule typedSrc = (LoadControlModule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.LoadControlTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.LoadControlTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LoadControlModule typedSrc = (LoadControlModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.LoadControlTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.loadControl);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.loadmodule.LoadControlTypeSupport.get_instance().serialize(endpoint_data, typedSrc.loadControl, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadControlModule typedDst = (LoadControlModule) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.loadControl = (org.openfmb.model.dds.rti.openfmb.loadmodule.LoadControl)org.openfmb.model.dds.rti.openfmb.loadmodule.LoadControlTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.loadControl, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.loadmodule.LoadControlTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadControlModule typedDst = (LoadControlModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        LoadControlModule typedDst
        = (LoadControlModule) instance;
        LoadControlModule typedSrc
        = (LoadControlModule) key;
    ...
    */
    ...
    int mask) {
        return new LoadControlModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LoadControlModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected LoadControlModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,LoadControlModuleTypeCode.VALUE,LoadControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadControlModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadControlModuleTypeCode.VALUE,LoadControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
