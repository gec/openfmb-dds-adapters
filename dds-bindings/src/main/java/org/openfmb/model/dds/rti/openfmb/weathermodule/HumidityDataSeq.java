...
/**
* A sequence of HumidityData instances.
*/
public final class HumidityDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HumidityDataSeq() {
        super(HumidityData.class);
    }

    public HumidityDataSeq (int initialMaximum) {
        super(HumidityData.class, initialMaximum);
    }

    public HumidityDataSeq (Collection elements) {
        super(HumidityData.class, elements);
    }
