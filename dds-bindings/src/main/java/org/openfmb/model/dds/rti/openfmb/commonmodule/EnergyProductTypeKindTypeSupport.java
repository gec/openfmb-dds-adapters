...
* EnergyProductTypeKind
*/

public class EnergyProductTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::EnergyProductTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EnergyProductTypeKindTypeSupport _singleton
    = new EnergyProductTypeKindTypeSupport();
    ...
    */
    public static EnergyProductTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static EnergyProductTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EnergyProductTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return EnergyProductTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>EnergyProductTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        EnergyProductTypeKind typedSrc = (EnergyProductTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = EnergyProductTypeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected EnergyProductTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EnergyProductTypeKindTypeCode.VALUE,EnergyProductTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
