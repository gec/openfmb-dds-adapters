...
* SequenceOfLoadReadings
*/

public class SequenceOfLoadReadingsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::SequenceOfLoadReadings";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfLoadReadingsTypeSupport _singleton
    = new SequenceOfLoadReadingsTypeSupport();
    ...
    */
    public static SequenceOfLoadReadingsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfLoadReadingsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfLoadReadingsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfLoadReadings.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfLoadReadings();
    }
    ...
    public Class get_type() {
        return SequenceOfLoadReadings.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfLoadReadings</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfLoadReadings typedDst = (SequenceOfLoadReadings) destination;
        SequenceOfLoadReadings typedSrc = (SequenceOfLoadReadings) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadReadings.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfLoadReadings typedSrc = (SequenceOfLoadReadings) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadReadings.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfLoadReadings typedDst = (SequenceOfLoadReadings) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadReadings.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfLoadReadings typedDst = (SequenceOfLoadReadings) sample;
    ...
    protected SequenceOfLoadReadingsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfLoadReadingsTypeCode.VALUE,SequenceOfLoadReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfLoadReadingsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfLoadReadingsTypeCode.VALUE,SequenceOfLoadReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
