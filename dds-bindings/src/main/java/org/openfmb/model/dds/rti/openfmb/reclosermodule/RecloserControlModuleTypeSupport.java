...
public class RecloserControlModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::RecloserControlModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserControlModuleTypeSupport _singleton
    = new RecloserControlModuleTypeSupport();
    ...
    */
    public static RecloserControlModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserControlModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserControlModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserControlModule.create();
    }
    ...
    public Object create_key() {
        return new RecloserControlModule();
    }
    ...
    public Class get_type() {
        return RecloserControlModule.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserControlModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserControlModule typedDst = (RecloserControlModule) destination;
        RecloserControlModule typedSrc = (RecloserControlModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RecloserControlModule typedSrc = (RecloserControlModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserControlModule typedDst = (RecloserControlModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserControlModule typedDst = (RecloserControlModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RecloserControlModule typedDst
        = (RecloserControlModule) instance;
        RecloserControlModule typedSrc
        = (RecloserControlModule) key;
    ...
    */
    ...
    int mask) {
        return new RecloserControlModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RecloserControlModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected RecloserControlModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RecloserControlModuleTypeCode.VALUE,RecloserControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserControlModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserControlModuleTypeCode.VALUE,RecloserControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
