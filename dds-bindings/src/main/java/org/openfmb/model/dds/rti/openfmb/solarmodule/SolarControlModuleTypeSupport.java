...
public class SolarControlModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarControlModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarControlModuleTypeSupport _singleton
    = new SolarControlModuleTypeSupport();
    ...
    */
    public static SolarControlModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarControlModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarControlModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarControlModule.create();
    }
    ...
    public Class get_type() {
        return SolarControlModule.class;
    }
    ...
    * <code>this</code> is not a <code>SolarControlModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarControlModule typedDst = (SolarControlModule) destination;
        SolarControlModule typedSrc = (SolarControlModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarControlModule typedSrc = (SolarControlModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarControlModule typedDst = (SolarControlModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarControlModule typedDst = (SolarControlModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarControlModule typedDst
        = (SolarControlModule) instance;
        SolarControlModule typedSrc
        = (SolarControlModule) key;
    ...
    */
    ...
    int mask) {
        return new SolarControlModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarControlModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarControlModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarControlModuleTypeCode.VALUE,SolarControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarControlModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarControlModuleTypeCode.VALUE,SolarControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
