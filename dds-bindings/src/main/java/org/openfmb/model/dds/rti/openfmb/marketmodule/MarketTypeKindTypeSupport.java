...
public class MarketTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::MarketTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarketTypeKindTypeSupport _singleton
    = new MarketTypeKindTypeSupport();
    ...
    */
    public static MarketTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static MarketTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarketTypeKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>MarketTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        MarketTypeKind typedSrc = (MarketTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = MarketTypeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected MarketTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarketTypeKindTypeCode.VALUE,MarketTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
