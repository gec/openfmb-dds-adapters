...
public class RecloserReadingModule   implements Copyable, Serializable{
    ...
    public RecloserReadingModule() {

    }
    public RecloserReadingModule (RecloserReadingModule other) {
    ...
    public static Object create() {
        ...
        RecloserReadingModule self;
        self = new  RecloserReadingModule();
        self.clear();
        return self;
    ...
    public boolean equals(Object o) {
        ...
        RecloserReadingModule otherObj = (RecloserReadingModule)o;
    ...
    * This method could be placed into <code>RecloserReadingModuleTypeSupport</code>
    ...
    */
    public Object copy_from(Object src) {
        ...
        RecloserReadingModule typedSrc = (RecloserReadingModule) src;
        RecloserReadingModule typedDst = this;
