...
public class MeterTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::resourcemodule::Meter";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MeterTypeSupport _singleton
    = new MeterTypeSupport();
    ...
    */
    public static MeterTypeSupport get_instance() {
        return _singleton;
    }

    public static MeterTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MeterTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Meter</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Meter typedDst = (Meter) destination;
        Meter typedSrc = (Meter) source;
    ...
    protected MeterTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MeterTypeCode.VALUE,Meter.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MeterTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MeterTypeCode.VALUE,Meter.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
