...
public class EnergyConsumerTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::EnergyConsumer";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EnergyConsumerTypeSupport _singleton
    = new EnergyConsumerTypeSupport();
    ...
    */
    public static EnergyConsumerTypeSupport get_instance() {
        return _singleton;
    }

    public static EnergyConsumerTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EnergyConsumerTypeCode.VALUE;
    }

    public Object create_data() {
        return EnergyConsumer.create();
    }
    ...
    * <code>this</code> is not a <code>EnergyConsumer</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EnergyConsumer typedDst = (EnergyConsumer) destination;
        EnergyConsumer typedSrc = (EnergyConsumer) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EnergyConsumer typedSrc = (EnergyConsumer) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.operatingLimit );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.operatingLimit,(255));
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EnergyConsumer typedDst = (EnergyConsumer) sample;
    ...
    protected EnergyConsumerTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EnergyConsumerTypeCode.VALUE,EnergyConsumer.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EnergyConsumerTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EnergyConsumerTypeCode.VALUE,EnergyConsumer.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
