...
public class UnitMultiplierKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::unitmultiplier::UnitMultiplierKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UnitMultiplierKindTypeSupport _singleton
    = new UnitMultiplierKindTypeSupport();
    ...
    */
    public static UnitMultiplierKindTypeSupport get_instance() {
        return _singleton;
    }

    public static UnitMultiplierKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UnitMultiplierKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return UnitMultiplierKind.class;
    }
    ...
    * <code>this</code> is not a <code>UnitMultiplierKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        UnitMultiplierKind typedSrc = (UnitMultiplierKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = UnitMultiplierKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected UnitMultiplierKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UnitMultiplierKindTypeCode.VALUE,UnitMultiplierKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
