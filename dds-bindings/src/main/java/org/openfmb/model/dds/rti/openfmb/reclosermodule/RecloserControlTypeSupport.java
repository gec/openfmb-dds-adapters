...
public class RecloserControlTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::RecloserControl";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserControlTypeSupport _singleton
    = new RecloserControlTypeSupport();
    ...
    */
    public static RecloserControlTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserControlTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserControlTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserControl.create();
    }
    ...
    * <code>this</code> is not a <code>RecloserControl</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserControl typedDst = (RecloserControl) destination;
        RecloserControl typedSrc = (RecloserControl) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserControlSetPointsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserControlSetPointsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RecloserControl typedSrc = (RecloserControl) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserControlSetPointsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserControlSetPointsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.setPoints, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserControl typedDst = (RecloserControl) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.setPoints = (org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserControlSetPoints)org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserControlSetPointsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.setPoints, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.reclosermodule.SequenceOfRecloserControlSetPointsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserControl typedDst = (RecloserControl) sample;
    ...
    protected RecloserControlTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RecloserControlTypeCode.VALUE,RecloserControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserControlTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserControlTypeCode.VALUE,RecloserControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
