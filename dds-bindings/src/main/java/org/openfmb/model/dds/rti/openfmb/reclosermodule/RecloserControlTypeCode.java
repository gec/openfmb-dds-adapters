...
public class  RecloserControlTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_value_tc("openfmb::reclosermodule::RecloserControl",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY, VM_NONE.VALUE,org.openfmb.model.dds.rti.openfmb.commonmodule.EndDeviceControlTypeCode.VALUE, sm);        
        return tc;
    }
}
