...
public class  WeatherDataProfileTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("weatherData", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.openfmb.weathermodule.WeatherDataTypeCode.VALUE,2 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("openfmb::weathermodule::WeatherDataProfile",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
