...
/**
* A sequence of LoadControl instances.
*/
public final class LoadControlSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public LoadControlSeq() {
        super(LoadControl.class);
    }

    public LoadControlSeq (int initialMaximum) {
        super(LoadControl.class, initialMaximum);
    }

    public LoadControlSeq (Collection elements) {
        super(LoadControl.class, elements);
    }
