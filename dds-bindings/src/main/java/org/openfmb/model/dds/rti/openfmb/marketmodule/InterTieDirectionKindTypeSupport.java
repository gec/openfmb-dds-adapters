...
* InterTieDirectionKind
*/

public class InterTieDirectionKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::InterTieDirectionKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InterTieDirectionKindTypeSupport _singleton
    = new InterTieDirectionKindTypeSupport();
    ...
    */
    public static InterTieDirectionKindTypeSupport get_instance() {
        return _singleton;
    }

    public static InterTieDirectionKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InterTieDirectionKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return InterTieDirectionKind.class;
    }
    ...
    * <code>this</code> is not a <code>InterTieDirectionKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        InterTieDirectionKind typedSrc = (InterTieDirectionKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = InterTieDirectionKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected InterTieDirectionKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,InterTieDirectionKindTypeCode.VALUE,InterTieDirectionKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
