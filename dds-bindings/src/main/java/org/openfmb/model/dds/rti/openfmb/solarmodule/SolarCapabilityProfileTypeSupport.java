...
public class SolarCapabilityProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarCapabilityProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarCapabilityProfileTypeSupport _singleton
    = new SolarCapabilityProfileTypeSupport();
    ...
    */
    public static SolarCapabilityProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarCapabilityProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarCapabilityProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarCapabilityProfile.create();
    }
    ...
    public Class get_type() {
        return SolarCapabilityProfile.class;
    }
    ...
    * <code>this</code> is not a <code>SolarCapabilityProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarCapabilityProfile typedDst = (SolarCapabilityProfile) destination;
        SolarCapabilityProfile typedSrc = (SolarCapabilityProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SolarCapabilityTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SolarCapabilityTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarCapabilityProfile typedSrc = (SolarCapabilityProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SolarCapabilityTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.solarmodule.SolarCapabilityTypeSupport.get_instance().serialize(endpoint_data, typedSrc.solarCapability, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarCapabilityProfile typedDst = (SolarCapabilityProfile) dst;
            typedDst.clear();      
            try{
                typedDst.logicalDeviceID = src.readString((255));
                typedDst.timestamp = src.readLong();
                typedDst.solarCapability = (org.openfmb.model.dds.rti.openfmb.solarmodule.SolarCapability)org.openfmb.model.dds.rti.openfmb.solarmodule.SolarCapabilityTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.solarCapability, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.solarmodule.SolarCapabilityTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarCapabilityProfile typedDst = (SolarCapabilityProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarCapabilityProfile typedDst
        = (SolarCapabilityProfile) instance;
        SolarCapabilityProfile typedSrc
        = (SolarCapabilityProfile) key;
    ...
    */
    ...
    int mask) {
        return new SolarCapabilityProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarCapabilityProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarCapabilityProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarCapabilityProfileTypeCode.VALUE,SolarCapabilityProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarCapabilityProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarCapabilityProfileTypeCode.VALUE,SolarCapabilityProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
