...
public class EndDeviceControlTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::EndDeviceControlType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EndDeviceControlTypeTypeSupport _singleton
    = new EndDeviceControlTypeTypeSupport();
    ...
    */
    public static EndDeviceControlTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static EndDeviceControlTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EndDeviceControlTypeTypeCode.VALUE;
    }

    public Object create_data() {
        return EndDeviceControlType.create();
    }
    ...
    public Class get_type() {
        return EndDeviceControlType.class;
    }
    ...
    * <code>this</code> is not a <code>EndDeviceControlType</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EndDeviceControlType typedDst = (EndDeviceControlType) destination;
        EndDeviceControlType typedSrc = (EndDeviceControlType) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        EndDeviceControlType typedSrc = (EndDeviceControlType) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.action,(255));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            EndDeviceControlType typedDst = (EndDeviceControlType) dst;
            typedDst.clear();      
            try{
                typedDst.action = src.readString((255));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            EndDeviceControlType typedDst = (EndDeviceControlType) sample;
    ...
    protected EndDeviceControlTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EndDeviceControlTypeTypeCode.VALUE,EndDeviceControlType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EndDeviceControlTypeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EndDeviceControlTypeTypeCode.VALUE,EndDeviceControlType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
