...
public class SolarForecastProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarForecastProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarForecastProfileTypeSupport _singleton
    = new SolarForecastProfileTypeSupport();
    ...
    */
    public static SolarForecastProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarForecastProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarForecastProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarForecastProfile.create();
    }
    ...
    public Class get_type() {
        return SolarForecastProfile.class;
    }
    ...
    * <code>this</code> is not a <code>SolarForecastProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarForecastProfile typedDst = (SolarForecastProfile) destination;
        SolarForecastProfile typedSrc = (SolarForecastProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarForecastProfile typedSrc = (SolarForecastProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarForecastProfile typedDst = (SolarForecastProfile) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarForecastProfile typedDst = (SolarForecastProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarForecastProfile typedDst
        = (SolarForecastProfile) instance;
        SolarForecastProfile typedSrc
        = (SolarForecastProfile) key;
    ...
    */
    ...
    int mask) {
        return new SolarForecastProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarForecastProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarForecastProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarForecastProfileTypeCode.VALUE,SolarForecastProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarForecastProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarForecastProfileTypeCode.VALUE,SolarForecastProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
