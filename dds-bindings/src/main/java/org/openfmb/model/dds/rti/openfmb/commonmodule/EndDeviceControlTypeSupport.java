...
public class EndDeviceControlTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::EndDeviceControl";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final EndDeviceControlTypeSupport _singleton
    = new EndDeviceControlTypeSupport();
    ...
    */
    public static EndDeviceControlTypeSupport get_instance() {
        return _singleton;
    }

    public static EndDeviceControlTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return EndDeviceControlTypeCode.VALUE;
    }

    public Object create_data() {
        return EndDeviceControl.create();
    }
    ...
    * <code>this</code> is not a <code>EndDeviceControl</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        EndDeviceControl typedDst = (EndDeviceControl) destination;
        EndDeviceControl typedSrc = (EndDeviceControl) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfEndDeviceControlSetPointsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfEndDeviceControlSetPointsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfEndDeviceControlSetPointsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfEndDeviceControlSetPointsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.setPoints, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.setPoints = (org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfEndDeviceControlSetPoints)org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfEndDeviceControlSetPointsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.setPoints, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfEndDeviceControlSetPointsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
    ...
    protected EndDeviceControlTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,EndDeviceControlTypeCode.VALUE,EndDeviceControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected EndDeviceControlTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,EndDeviceControlTypeCode.VALUE,EndDeviceControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
