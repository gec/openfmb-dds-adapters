...
/**
* A sequence of HexBinary16Type instances.
*/
public final class HexBinary16TypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public HexBinary16TypeSeq() {
        super(HexBinary16Type.class);
    }

    public HexBinary16TypeSeq (int initialMaximum) {
        super(HexBinary16Type.class, initialMaximum);
    }

    public HexBinary16TypeSeq (Collection elements) {
        super(HexBinary16Type.class, elements);
    }
