...
public class ResourceStatusProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::resourcemodule::ResourceStatusProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ResourceStatusProfileTypeSupport _singleton
    = new ResourceStatusProfileTypeSupport();
    ...
    */
    public static ResourceStatusProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static ResourceStatusProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ResourceStatusProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return ResourceStatusProfile.create();
    }
    ...
    public Class get_type() {
        return ResourceStatusProfile.class;
    }
    ...
    * <code>this</code> is not a <code>ResourceStatusProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ResourceStatusProfile typedDst = (ResourceStatusProfile) destination;
        ResourceStatusProfile typedSrc = (ResourceStatusProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.resourcemodule.SequenceOfResourceStatusMeasurementsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.resourcemodule.SequenceOfResourceStatusMeasurementsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ResourceStatusProfile typedSrc = (ResourceStatusProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.resourcemodule.SequenceOfResourceStatusMeasurementsTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.measurements);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.resourcemodule.SequenceOfResourceStatusMeasurementsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.measurements, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ResourceStatusProfile typedDst = (ResourceStatusProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.measurements = (org.openfmb.model.dds.rti.openfmb.resourcemodule.SequenceOfResourceStatusMeasurements)org.openfmb.model.dds.rti.openfmb.resourcemodule.SequenceOfResourceStatusMeasurementsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.measurements, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.resourcemodule.SequenceOfResourceStatusMeasurementsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ResourceStatusProfile typedDst = (ResourceStatusProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ResourceStatusProfile typedDst
        = (ResourceStatusProfile) instance;
        ResourceStatusProfile typedSrc
        = (ResourceStatusProfile) key;
    ...
    */
    ...
    int mask) {
        return new ResourceStatusProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ResourceStatusProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected ResourceStatusProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ResourceStatusProfileTypeCode.VALUE,ResourceStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ResourceStatusProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ResourceStatusProfileTypeCode.VALUE,ResourceStatusProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
