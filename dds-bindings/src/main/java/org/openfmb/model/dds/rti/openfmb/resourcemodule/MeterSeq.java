...
/**
* A sequence of Meter instances.
*/
public final class MeterSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MeterSeq (int initialMaximum) {
        super(Meter.class, initialMaximum);
    }

    public MeterSeq (Collection elements) {
        super(Meter.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Meter objects (beyond the original size of this object)
