...
* SequenceOfMarketFactors
*/

public class SequenceOfMarketFactorsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::interchangemodule::SequenceOfMarketFactors";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfMarketFactorsTypeSupport _singleton
    = new SequenceOfMarketFactorsTypeSupport();
    ...
    */
    public static SequenceOfMarketFactorsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfMarketFactorsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfMarketFactorsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfMarketFactors.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfMarketFactors();
    }
    ...
    public Class get_type() {
        return SequenceOfMarketFactors.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfMarketFactors</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfMarketFactors typedDst = (SequenceOfMarketFactors) destination;
        SequenceOfMarketFactors typedSrc = (SequenceOfMarketFactors) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketFactorsTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.interchangemodule.MaxLengthMarketFactors.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketFactorsTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfMarketFactors typedSrc = (SequenceOfMarketFactors) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketFactorsTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketFactorsTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.interchangemodule.MaxLengthMarketFactors.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfMarketFactors typedDst = (SequenceOfMarketFactors) dst;
            org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketFactorsTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.interchangemodule.MaxLengthMarketFactors.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketFactorsTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfMarketFactors typedDst = (SequenceOfMarketFactors) sample;
    ...
    protected SequenceOfMarketFactorsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfMarketFactorsTypeCode.VALUE,SequenceOfMarketFactors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfMarketFactorsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfMarketFactorsTypeCode.VALUE,SequenceOfMarketFactors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
