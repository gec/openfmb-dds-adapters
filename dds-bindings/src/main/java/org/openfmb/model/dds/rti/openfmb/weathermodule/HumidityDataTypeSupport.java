...
public class HumidityDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::HumidityData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HumidityDataTypeSupport _singleton
    = new HumidityDataTypeSupport();
    ...
    */
    public static HumidityDataTypeSupport get_instance() {
        return _singleton;
    }

    public static HumidityDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HumidityDataTypeCode.VALUE;
    }

    public Object create_data() {
        return HumidityData.create();
    }
    ...
    * <code>this</code> is not a <code>HumidityData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HumidityData typedDst = (HumidityData) destination;
        HumidityData typedSrc = (HumidityData) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        HumidityData typedSrc = (HumidityData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HumidityData typedDst = (HumidityData) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HumidityData typedDst = (HumidityData) sample;
    ...
    protected HumidityDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,HumidityDataTypeCode.VALUE,HumidityData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HumidityDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HumidityDataTypeCode.VALUE,HumidityData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
