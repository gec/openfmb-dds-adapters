...
public class GenerationReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationReadingProfileTypeSupport _singleton
    = new GenerationReadingProfileTypeSupport();
    ...
    */
    public static GenerationReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationReadingProfile.create();
    }
    ...
    public Class get_type() {
        return GenerationReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationReadingProfile typedDst = (GenerationReadingProfile) destination;
        GenerationReadingProfile typedSrc = (GenerationReadingProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationReadingProfile typedSrc = (GenerationReadingProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationReadingProfile typedDst = (GenerationReadingProfile) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationReadingProfile typedDst = (GenerationReadingProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationReadingProfile typedDst
        = (GenerationReadingProfile) instance;
        GenerationReadingProfile typedSrc
        = (GenerationReadingProfile) key;
    ...
    */
    ...
    int mask) {
        return new GenerationReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationReadingProfileTypeCode.VALUE,GenerationReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationReadingProfileTypeCode.VALUE,GenerationReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
