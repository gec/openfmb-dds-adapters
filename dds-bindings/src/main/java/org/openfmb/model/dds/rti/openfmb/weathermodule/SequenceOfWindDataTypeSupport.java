...
public class SequenceOfWindDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::SequenceOfWindData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfWindDataTypeSupport _singleton
    = new SequenceOfWindDataTypeSupport();
    ...
    */
    public static SequenceOfWindDataTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfWindDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfWindDataTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfWindData.create();
    }
    ...
    public Class get_type() {
        return SequenceOfWindData.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfWindData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfWindData typedDst = (SequenceOfWindData) destination;
        SequenceOfWindData typedSrc = (SequenceOfWindData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.WindDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthWindData.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.WindDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfWindData typedSrc = (SequenceOfWindData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.WindDataTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.WindDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthWindData.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfWindData typedDst = (SequenceOfWindData) dst;
            org.openfmb.model.dds.rti.openfmb.weathermodule.WindDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthWindData.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.WindDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfWindData typedDst = (SequenceOfWindData) sample;
    ...
    protected SequenceOfWindDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfWindDataTypeCode.VALUE,SequenceOfWindData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfWindDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfWindDataTypeCode.VALUE,SequenceOfWindData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
