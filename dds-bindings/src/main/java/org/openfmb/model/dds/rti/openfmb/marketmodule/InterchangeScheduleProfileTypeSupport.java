...
public class InterchangeScheduleProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::InterchangeScheduleProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InterchangeScheduleProfileTypeSupport _singleton
    = new InterchangeScheduleProfileTypeSupport();
    ...
    */
    public static InterchangeScheduleProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static InterchangeScheduleProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InterchangeScheduleProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return InterchangeScheduleProfile.create();
    }
    ...
    public Class get_type() {
        return InterchangeScheduleProfile.class;
    }
    ...
    * <code>this</code> is not a <code>InterchangeScheduleProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        InterchangeScheduleProfile typedDst = (InterchangeScheduleProfile) destination;
        InterchangeScheduleProfile typedSrc = (InterchangeScheduleProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        InterchangeScheduleProfile typedSrc = (InterchangeScheduleProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    public long serialize_to_cdr_buffer(
        byte[] buffer,
        long length,
        InterchangeScheduleProfile src)
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            InterchangeScheduleProfile typedDst = (InterchangeScheduleProfile) dst;
            typedDst.clear();      
            try{
    ...
    public void deserialize_from_cdr_buffer(
        InterchangeScheduleProfile dst,
        byte[] buffer,
        long length) 
    {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            InterchangeScheduleProfile typedDst = (InterchangeScheduleProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        InterchangeScheduleProfile typedDst
        = (InterchangeScheduleProfile) instance;
        InterchangeScheduleProfile typedSrc
        = (InterchangeScheduleProfile) key;
    ...
    */
    ...
    int mask) {
        return new InterchangeScheduleProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new InterchangeScheduleProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected InterchangeScheduleProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,InterchangeScheduleProfileTypeCode.VALUE,InterchangeScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected InterchangeScheduleProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,InterchangeScheduleProfileTypeCode.VALUE,InterchangeScheduleProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
