...
/**
* A sequence of SolarEventModule instances.
*/
public final class SolarEventModuleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SolarEventModuleSeq() {
        super(SolarEventModule.class);
    }

    public SolarEventModuleSeq (int initialMaximum) {
        super(SolarEventModule.class, initialMaximum);
    }

    public SolarEventModuleSeq (Collection elements) {
        super(SolarEventModule.class, elements);
    }
