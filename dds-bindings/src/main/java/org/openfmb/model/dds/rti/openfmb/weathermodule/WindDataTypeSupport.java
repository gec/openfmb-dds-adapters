...
public class WindDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::WindData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WindDataTypeSupport _singleton
    = new WindDataTypeSupport();
    ...
    */
    public static WindDataTypeSupport get_instance() {
        return _singleton;
    }

    public static WindDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WindDataTypeCode.VALUE;
    }

    public Object create_data() {
        return WindData.create();
    }
    ...
    * <code>this</code> is not a <code>WindData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WindData typedDst = (WindData) destination;
        WindData typedSrc = (WindData) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WindData typedSrc = (WindData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.windDirection);

            dst.writeFloat(typedSrc.windSpeed);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WindData typedDst = (WindData) dst;
            typedDst.clear();      
            try{
                typedDst.timestamp = src.readLong();
                typedDst.windDirection = src.readFloat();
                typedDst.windSpeed = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WindData typedDst = (WindData) sample;
    ...
    protected WindDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WindDataTypeCode.VALUE,WindData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WindDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WindDataTypeCode.VALUE,WindData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
