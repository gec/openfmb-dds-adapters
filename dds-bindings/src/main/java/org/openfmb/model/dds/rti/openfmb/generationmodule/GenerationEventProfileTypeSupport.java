...
public class GenerationEventProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationEventProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationEventProfileTypeSupport _singleton
    = new GenerationEventProfileTypeSupport();
    ...
    */
    public static GenerationEventProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationEventProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationEventProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationEventProfile.create();
    }
    ...
    public Class get_type() {
        return GenerationEventProfile.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationEventProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationEventProfile typedDst = (GenerationEventProfile) destination;
        GenerationEventProfile typedSrc = (GenerationEventProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationEventProfile typedSrc = (GenerationEventProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationEventProfile typedDst = (GenerationEventProfile) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationEventProfile typedDst = (GenerationEventProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationEventProfile typedDst
        = (GenerationEventProfile) instance;
        GenerationEventProfile typedSrc
        = (GenerationEventProfile) key;
    ...
    */
    ...
    int mask) {
        return new GenerationEventProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationEventProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationEventProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationEventProfileTypeCode.VALUE,GenerationEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationEventProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationEventProfileTypeCode.VALUE,GenerationEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
