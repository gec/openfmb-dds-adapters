...
public class RecloserReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::RecloserReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserReadingProfileTypeSupport _singleton
    = new RecloserReadingProfileTypeSupport();
    ...
    */
    public static RecloserReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserReadingProfile.create();
    }
    ...
    public Class get_type() {
        return RecloserReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserReadingProfile typedDst = (RecloserReadingProfile) destination;
        RecloserReadingProfile typedSrc = (RecloserReadingProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RecloserReadingProfile typedSrc = (RecloserReadingProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserReadingProfile typedDst = (RecloserReadingProfile) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserReadingProfile typedDst = (RecloserReadingProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RecloserReadingProfile typedDst
        = (RecloserReadingProfile) instance;
        RecloserReadingProfile typedSrc
        = (RecloserReadingProfile) key;
    ...
    */
    ...
    int mask) {
        return new RecloserReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RecloserReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected RecloserReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RecloserReadingProfileTypeCode.VALUE,RecloserReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserReadingProfileTypeCode.VALUE,RecloserReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
