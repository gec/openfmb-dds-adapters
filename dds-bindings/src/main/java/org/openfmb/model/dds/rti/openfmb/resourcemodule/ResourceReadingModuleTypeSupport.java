...
* ResourceReadingModule
*/

public class ResourceReadingModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::resourcemodule::ResourceReadingModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ResourceReadingModuleTypeSupport _singleton
    = new ResourceReadingModuleTypeSupport();
    ...
    */
    public static ResourceReadingModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static ResourceReadingModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ResourceReadingModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return ResourceReadingModule.create();
    }
    ...
    public Object create_key() {
        return new ResourceReadingModule();
    }
    ...
    public Class get_type() {
        return ResourceReadingModule.class;
    }
    ...
    * <code>this</code> is not a <code>ResourceReadingModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ResourceReadingModule typedDst = (ResourceReadingModule) destination;
        ResourceReadingModule typedSrc = (ResourceReadingModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ResourceReadingModule typedSrc = (ResourceReadingModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ResourceReadingModule typedDst = (ResourceReadingModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ResourceReadingModule typedDst = (ResourceReadingModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        ResourceReadingModule typedDst
        = (ResourceReadingModule) instance;
        ResourceReadingModule typedSrc
        = (ResourceReadingModule) key;
    ...
    */
    ...
    int mask) {
        return new ResourceReadingModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ResourceReadingModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected ResourceReadingModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ResourceReadingModuleTypeCode.VALUE,ResourceReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ResourceReadingModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ResourceReadingModuleTypeCode.VALUE,ResourceReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
