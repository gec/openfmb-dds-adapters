...
public class HexBinary16TypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::HexBinary16Type";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HexBinary16TypeTypeSupport _singleton
    = new HexBinary16TypeTypeSupport();
    ...
    */
    public static HexBinary16TypeTypeSupport get_instance() {
        return _singleton;
    }

    public static HexBinary16TypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HexBinary16TypeTypeCode.VALUE;
    }

    public Object create_data() {
        return HexBinary16Type.create();
    }
    ...
    * <code>this</code> is not a <code>HexBinary16Type</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        HexBinary16Type typedDst = (HexBinary16Type) destination;
        HexBinary16Type typedSrc = (HexBinary16Type) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        HexBinary16Type typedSrc = (HexBinary16Type) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            for(int i1__ = 0; i1__< 2; ++i1__){
                ...
                dst.writeByte(typedSrc.data[i1__]);
            }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            HexBinary16Type typedDst = (HexBinary16Type) dst;
            typedDst.clear();      
            try{
                for(int i1__ = 0; i1__< 2; ++i1__){

                    typedDst.data[i1__] = src.readByte();
                }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            HexBinary16Type typedDst = (HexBinary16Type) sample;
    ...
    protected HexBinary16TypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,HexBinary16TypeTypeCode.VALUE,HexBinary16Type.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HexBinary16TypeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HexBinary16TypeTypeCode.VALUE,HexBinary16Type.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
