...
public class MarketRunTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "openfmb::marketmodule::MarketRun";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.ExecutionTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((255))+1);
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.MarketTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.ExecutionTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.MarketTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.ExecutionTypeKindTypeSupport.get_instance().get_serialized_sample_size(
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.MarketTypeKindTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.ExecutionTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.executionType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.MarketTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.marketType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            try{
                typedDst.executionType = (org.openfmb.model.dds.rti.openfmb.marketmodule.ExecutionTypeKind)org.openfmb.model.dds.rti.openfmb.marketmodule.ExecutionTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.executionType, src, false, true, endpoint_plugin_qos);     
                ...
                typedDst.marketType = (org.openfmb.model.dds.rti.openfmb.marketmodule.MarketTypeKind)org.openfmb.model.dds.rti.openfmb.marketmodule.MarketTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marketType, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.ExecutionTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.MarketTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
