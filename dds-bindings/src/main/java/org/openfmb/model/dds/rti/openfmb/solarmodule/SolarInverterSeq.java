...
/**
* A sequence of SolarInverter instances.
*/
public final class SolarInverterSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SolarInverterSeq() {
        super(SolarInverter.class);
    }

    public SolarInverterSeq (int initialMaximum) {
        super(SolarInverter.class, initialMaximum);
    }

    public SolarInverterSeq (Collection elements) {
        super(SolarInverter.class, elements);
    }
