...
public class WeatherDataProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::WeatherDataProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WeatherDataProfileTypeSupport _singleton
    = new WeatherDataProfileTypeSupport();
    ...
    */
    public static WeatherDataProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static WeatherDataProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WeatherDataProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return WeatherDataProfile.create();
    }
    ...
    public Class get_type() {
        return WeatherDataProfile.class;
    }
    ...
    * <code>this</code> is not a <code>WeatherDataProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WeatherDataProfile typedDst = (WeatherDataProfile) destination;
        WeatherDataProfile typedSrc = (WeatherDataProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.WeatherDataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.WeatherDataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WeatherDataProfile typedSrc = (WeatherDataProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.WeatherDataTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.weatherData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.WeatherDataTypeSupport.get_instance().serialize(endpoint_data, typedSrc.weatherData, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            WeatherDataProfile typedDst = (WeatherDataProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.weatherData = (org.openfmb.model.dds.rti.openfmb.weathermodule.WeatherData)org.openfmb.model.dds.rti.openfmb.weathermodule.WeatherDataTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.weatherData, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.WeatherDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WeatherDataProfile typedDst = (WeatherDataProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        WeatherDataProfile typedDst
        = (WeatherDataProfile) instance;
        WeatherDataProfile typedSrc
        = (WeatherDataProfile) key;
    ...
    */
    ...
    int mask) {
        return new WeatherDataProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new WeatherDataProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected WeatherDataProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,WeatherDataProfileTypeCode.VALUE,WeatherDataProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WeatherDataProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WeatherDataProfileTypeCode.VALUE,WeatherDataProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
