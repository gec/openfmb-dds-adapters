...
public class SequenceOfCurveDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::SequenceOfCurveData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfCurveDataTypeSupport _singleton
    = new SequenceOfCurveDataTypeSupport();
    ...
    */
    public static SequenceOfCurveDataTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfCurveDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfCurveDataTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfCurveData.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfCurveData();
    }
    ...
    public Class get_type() {
        return SequenceOfCurveData.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfCurveData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfCurveData typedDst = (SequenceOfCurveData) destination;
        SequenceOfCurveData typedSrc = (SequenceOfCurveData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.CurveDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthCurveData.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.CurveDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfCurveData typedSrc = (SequenceOfCurveData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.CurveDataTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.CurveDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthCurveData.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfCurveData typedDst = (SequenceOfCurveData) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.CurveDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthCurveData.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.CurveDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfCurveData typedDst = (SequenceOfCurveData) sample;
    ...
    protected SequenceOfCurveDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfCurveDataTypeCode.VALUE,SequenceOfCurveData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfCurveDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfCurveDataTypeCode.VALUE,SequenceOfCurveData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
