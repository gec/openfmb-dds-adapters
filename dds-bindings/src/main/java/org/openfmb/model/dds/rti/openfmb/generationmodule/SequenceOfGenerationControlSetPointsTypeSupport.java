...
* SequenceOfGenerationControlSetPoints
*/

public class SequenceOfGenerationControlSetPointsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::SequenceOfGenerationControlSetPoints";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfGenerationControlSetPointsTypeSupport _singleton
    = new SequenceOfGenerationControlSetPointsTypeSupport();
    ...
    */
    public static SequenceOfGenerationControlSetPointsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfGenerationControlSetPointsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfGenerationControlSetPointsTypeCode.VALUE;
    }
    ...
    public Object create_key() {
        return new SequenceOfGenerationControlSetPoints();
    }
    ...
    public Class get_type() {
        return SequenceOfGenerationControlSetPoints.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfGenerationControlSetPoints</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfGenerationControlSetPoints typedDst = (SequenceOfGenerationControlSetPoints) destination;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.generationmodule.MaxLengthGenerationControlSetPoints.VALUE)));
        if (include_encapsulation) {
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.generationmodule.MaxLengthGenerationControlSetPoints.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfGenerationControlSetPoints typedDst = (SequenceOfGenerationControlSetPoints) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.generationmodule.MaxLengthGenerationControlSetPoints.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    protected SequenceOfGenerationControlSetPointsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfGenerationControlSetPointsTypeCode.VALUE,SequenceOfGenerationControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfGenerationControlSetPointsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfGenerationControlSetPointsTypeCode.VALUE,SequenceOfGenerationControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
