...
* SequenceOfStringMeasurements
*/

public class SequenceOfStringMeasurementsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::SequenceOfStringMeasurements";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfStringMeasurementsTypeSupport _singleton
    = new SequenceOfStringMeasurementsTypeSupport();
    ...
    */
    public static SequenceOfStringMeasurementsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfStringMeasurementsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfStringMeasurementsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfStringMeasurements.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfStringMeasurements();
    }
    ...
    public Class get_type() {
        return SequenceOfStringMeasurements.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfStringMeasurements</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfStringMeasurements typedDst = (SequenceOfStringMeasurements) destination;
        SequenceOfStringMeasurements typedSrc = (SequenceOfStringMeasurements) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthStringMeasurements.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfStringMeasurements typedSrc = (SequenceOfStringMeasurements) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthStringMeasurements.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfStringMeasurements typedDst = (SequenceOfStringMeasurements) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthStringMeasurements.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfStringMeasurements typedDst = (SequenceOfStringMeasurements) sample;
    ...
    protected SequenceOfStringMeasurementsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfStringMeasurementsTypeCode.VALUE,SequenceOfStringMeasurements.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfStringMeasurementsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfStringMeasurementsTypeCode.VALUE,SequenceOfStringMeasurements.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
