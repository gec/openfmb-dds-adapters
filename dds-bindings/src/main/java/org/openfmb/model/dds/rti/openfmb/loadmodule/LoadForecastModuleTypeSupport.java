...
public class LoadForecastModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::LoadForecastModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadForecastModuleTypeSupport _singleton
    = new LoadForecastModuleTypeSupport();
    ...
    */
    public static LoadForecastModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadForecastModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadForecastModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadForecastModule.create();
    }
    ...
    public Class get_type() {
        return LoadForecastModule.class;
    }
    ...
    * <code>this</code> is not a <code>LoadForecastModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadForecastModule typedDst = (LoadForecastModule) destination;
        LoadForecastModule typedSrc = (LoadForecastModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LoadForecastModule typedSrc = (LoadForecastModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadForecastModule typedDst = (LoadForecastModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadForecastModule typedDst = (LoadForecastModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        LoadForecastModule typedDst
        = (LoadForecastModule) instance;
        LoadForecastModule typedSrc
        = (LoadForecastModule) key;
    ...
    */
    ...
    int mask) {
        return new LoadForecastModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LoadForecastModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected LoadForecastModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,LoadForecastModuleTypeCode.VALUE,LoadForecastModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadForecastModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadForecastModuleTypeCode.VALUE,LoadForecastModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
