...
/**
* A sequence of SwitchStatusKind instances.
*/
public final class SwitchStatusKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SwitchStatusKindSeq() {
        super(SwitchStatusKind.class);
    }

    public SwitchStatusKindSeq (int initialMaximum) {
        super(SwitchStatusKind.class, initialMaximum);
    }

    public SwitchStatusKindSeq (Collection elements) {
        super(SwitchStatusKind.class, elements);
    }
