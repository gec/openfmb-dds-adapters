...
* SequenceOfLoadControlReadings
*/

public class SequenceOfLoadControlReadingsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::SequenceOfLoadControlReadings";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfLoadControlReadingsTypeSupport _singleton
    = new SequenceOfLoadControlReadingsTypeSupport();
    ...
    */
    public static SequenceOfLoadControlReadingsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfLoadControlReadingsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfLoadControlReadingsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfLoadControlReadings.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfLoadControlReadings();
    }
    ...
    public Class get_type() {
        return SequenceOfLoadControlReadings.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfLoadControlReadings</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfLoadControlReadings typedDst = (SequenceOfLoadControlReadings) destination;
        SequenceOfLoadControlReadings typedSrc = (SequenceOfLoadControlReadings) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadControlReadings.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfLoadControlReadings typedSrc = (SequenceOfLoadControlReadings) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadControlReadings.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfLoadControlReadings typedDst = (SequenceOfLoadControlReadings) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadControlReadings.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfLoadControlReadings typedDst = (SequenceOfLoadControlReadings) sample;
    ...
    protected SequenceOfLoadControlReadingsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfLoadControlReadingsTypeCode.VALUE,SequenceOfLoadControlReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfLoadControlReadingsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfLoadControlReadingsTypeCode.VALUE,SequenceOfLoadControlReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
