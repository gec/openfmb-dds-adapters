...
* MarketProductTypeKind
*/

public class MarketProductTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::MarketProductTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarketProductTypeKindTypeSupport _singleton
    = new MarketProductTypeKindTypeSupport();
    ...
    */
    public static MarketProductTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static MarketProductTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarketProductTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return MarketProductTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>MarketProductTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        MarketProductTypeKind typedSrc = (MarketProductTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = MarketProductTypeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected MarketProductTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarketProductTypeKindTypeCode.VALUE,MarketProductTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
