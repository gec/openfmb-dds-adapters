...
public class RecloserEventModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::RecloserEventModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserEventModuleTypeSupport _singleton
    = new RecloserEventModuleTypeSupport();
    ...
    */
    public static RecloserEventModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserEventModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserEventModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserEventModule.create();
    }
    ...
    public Object create_key() {
        return new RecloserEventModule();
    }
    ...
    public Class get_type() {
        return RecloserEventModule.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserEventModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserEventModule typedDst = (RecloserEventModule) destination;
        RecloserEventModule typedSrc = (RecloserEventModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RecloserEventModule typedSrc = (RecloserEventModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserEventModule typedDst = (RecloserEventModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserEventModule typedDst = (RecloserEventModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RecloserEventModule typedDst
        = (RecloserEventModule) instance;
        RecloserEventModule typedSrc
        = (RecloserEventModule) key;
    ...
    */
    ...
    int mask) {
        return new RecloserEventModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RecloserEventModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected RecloserEventModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RecloserEventModuleTypeCode.VALUE,RecloserEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserEventModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserEventModuleTypeCode.VALUE,RecloserEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
