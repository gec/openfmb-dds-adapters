...
/**
* A sequence of GeneratingUnit instances.
*/
public final class GeneratingUnitSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GeneratingUnitSeq() {
        super(GeneratingUnit.class);
    }

    public GeneratingUnitSeq (int initialMaximum) {
        super(GeneratingUnit.class, initialMaximum);
    }

    public GeneratingUnitSeq (Collection elements) {
        super(GeneratingUnit.class, elements);
    }
