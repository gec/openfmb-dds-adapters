...
public class MarketTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "openfmb::interchangemodule::Market";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((255))+1);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketFactorsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketRunsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketFactorsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketRunsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketFactorsTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.marketFactors);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketRunsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketFactorsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.marketFactors, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketRunsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.marketRuns, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.marketFactors = (org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketFactors)org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketFactorsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marketFactors, src, false, true, endpoint_plugin_qos);     
                typedDst.marketRuns = (org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketRuns)org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketRunsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marketRuns, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketFactorsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.interchangemodule.SequenceOfMarketRunsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
