...
public class  SolarCapabilityProfileTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("solarCapability", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.openfmb.solarmodule.SolarCapabilityTypeCode.VALUE,2 , false);__i++;
        ...
        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("openfmb::solarmodule::SolarCapabilityProfile",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
