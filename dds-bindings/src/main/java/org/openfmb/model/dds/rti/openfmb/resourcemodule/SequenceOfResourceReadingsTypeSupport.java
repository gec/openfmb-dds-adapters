...
* SequenceOfResourceReadings
*/

public class SequenceOfResourceReadingsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::resourcemodule::SequenceOfResourceReadings";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfResourceReadingsTypeSupport _singleton
    = new SequenceOfResourceReadingsTypeSupport();
    ...
    */
    public static SequenceOfResourceReadingsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfResourceReadingsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfResourceReadingsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfResourceReadings.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfResourceReadings();
    }
    ...
    public Class get_type() {
        return SequenceOfResourceReadings.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfResourceReadings</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfResourceReadings typedDst = (SequenceOfResourceReadings) destination;
        SequenceOfResourceReadings typedSrc = (SequenceOfResourceReadings) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.resourcemodule.MaxLengthResourceReadings.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfResourceReadings typedSrc = (SequenceOfResourceReadings) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.resourcemodule.MaxLengthResourceReadings.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfResourceReadings typedDst = (SequenceOfResourceReadings) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.resourcemodule.MaxLengthResourceReadings.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfResourceReadings typedDst = (SequenceOfResourceReadings) sample;
    ...
    protected SequenceOfResourceReadingsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfResourceReadingsTypeCode.VALUE,SequenceOfResourceReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfResourceReadingsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfResourceReadingsTypeCode.VALUE,SequenceOfResourceReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
