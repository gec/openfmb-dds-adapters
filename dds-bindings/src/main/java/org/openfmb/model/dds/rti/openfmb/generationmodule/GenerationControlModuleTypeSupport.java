...
* GenerationControlModule
*/

public class GenerationControlModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationControlModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationControlModuleTypeSupport _singleton
    = new GenerationControlModuleTypeSupport();
    ...
    */
    public static GenerationControlModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationControlModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationControlModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationControlModule.create();
    }
    ...
    public Object create_key() {
        return new GenerationControlModule();
    }
    ...
    public Class get_type() {
        return GenerationControlModule.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationControlModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationControlModule typedDst = (GenerationControlModule) destination;
        GenerationControlModule typedSrc = (GenerationControlModule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.GeneratingUnitTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationControlTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.GeneratingUnitTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationControlTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationControlModule typedSrc = (GenerationControlModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.GeneratingUnitTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.generatingUnit);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationControlTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.generationControl);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.generationmodule.GeneratingUnitTypeSupport.get_instance().serialize(endpoint_data, typedSrc.generatingUnit, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationControlTypeSupport.get_instance().serialize(endpoint_data, typedSrc.generationControl, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationControlModule typedDst = (GenerationControlModule) dst;
            typedDst.clear();      
            try{
                typedDst.logicalDeviceID = src.readString((255));
                typedDst.timestamp = src.readLong();
                typedDst.generatingUnit = (org.openfmb.model.dds.rti.openfmb.generationmodule.GeneratingUnit)org.openfmb.model.dds.rti.openfmb.generationmodule.GeneratingUnitTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.generatingUnit, src, false, true, endpoint_plugin_qos);     
                typedDst.generationControl = (org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationControl)org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationControlTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.generationControl, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.generationmodule.GeneratingUnitTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationControlTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationControlModule typedDst = (GenerationControlModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationControlModule typedDst
        = (GenerationControlModule) instance;
        GenerationControlModule typedSrc
        = (GenerationControlModule) key;
    ...
    */
    ...
    int mask) {
        return new GenerationControlModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationControlModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationControlModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationControlModuleTypeCode.VALUE,GenerationControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationControlModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationControlModuleTypeCode.VALUE,GenerationControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
