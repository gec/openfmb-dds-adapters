...
* SequenceOfSunRadiationData
*/

public class SequenceOfSunRadiationDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::SequenceOfSunRadiationData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfSunRadiationDataTypeSupport _singleton
    = new SequenceOfSunRadiationDataTypeSupport();
    ...
    */
    public static SequenceOfSunRadiationDataTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfSunRadiationDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfSunRadiationDataTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfSunRadiationData.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfSunRadiationData();
    }
    ...
    public Class get_type() {
        return SequenceOfSunRadiationData.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfSunRadiationData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfSunRadiationData typedDst = (SequenceOfSunRadiationData) destination;
        SequenceOfSunRadiationData typedSrc = (SequenceOfSunRadiationData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthSunRadiationData.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfSunRadiationData typedSrc = (SequenceOfSunRadiationData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationDataTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthSunRadiationData.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfSunRadiationData typedDst = (SequenceOfSunRadiationData) dst;
            org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthSunRadiationData.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfSunRadiationData typedDst = (SequenceOfSunRadiationData) sample;
    ...
    protected SequenceOfSunRadiationDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfSunRadiationDataTypeCode.VALUE,SequenceOfSunRadiationData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfSunRadiationDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfSunRadiationDataTypeCode.VALUE,SequenceOfSunRadiationData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
