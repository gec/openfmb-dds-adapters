...
public class RecloserStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::RecloserStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserStatusTypeSupport _singleton
    = new RecloserStatusTypeSupport();
    ...
    */
    public static RecloserStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserStatus.create();
    }
    ...
    * <code>this</code> is not a <code>RecloserStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserStatus typedDst = (RecloserStatus) destination;
        RecloserStatus typedSrc = (RecloserStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RecloserStatus typedSrc = (RecloserStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserStatus typedDst = (RecloserStatus) sample;
    ...
    protected RecloserStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RecloserStatusTypeCode.VALUE,RecloserStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserStatusTypeCode.VALUE,RecloserStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
