...
public class CurveDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::CurveData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CurveDataTypeSupport _singleton
    = new CurveDataTypeSupport();
    ...
    */
    public static CurveDataTypeSupport get_instance() {
        return _singleton;
    }

    public static CurveDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CurveDataTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CurveData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        CurveData typedDst = (CurveData) destination;
        CurveData typedSrc = (CurveData) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        CurveData typedSrc = (CurveData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.y2value);

            dst.writeFloat(typedSrc.y3value);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            CurveData typedDst = (CurveData) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            CurveData typedDst = (CurveData) sample;
    ...
    protected CurveDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CurveDataTypeCode.VALUE,CurveData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected CurveDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,CurveDataTypeCode.VALUE,CurveData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
