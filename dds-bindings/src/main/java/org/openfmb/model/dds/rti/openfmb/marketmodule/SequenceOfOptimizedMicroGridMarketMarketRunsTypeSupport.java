...
* SequenceOfOptimizedMicroGridMarketMarketRuns
*/

public class SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::SequenceOfOptimizedMicroGridMarketMarketRuns";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport _singleton
    = new SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport();
    ...
    */
    public static SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfOptimizedMicroGridMarketMarketRunsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfOptimizedMicroGridMarketMarketRuns.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfOptimizedMicroGridMarketMarketRuns();
    }
    ...
    public Class get_type() {
        return SequenceOfOptimizedMicroGridMarketMarketRuns.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfOptimizedMicroGridMarketMarketRuns</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfOptimizedMicroGridMarketMarketRuns typedDst = (SequenceOfOptimizedMicroGridMarketMarketRuns) destination;
        SequenceOfOptimizedMicroGridMarketMarketRuns typedSrc = (SequenceOfOptimizedMicroGridMarketMarketRuns) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.MarketRunTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.marketmodule.MaxLengthOptimizedMicroGridMarketMarketRuns.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.MarketRunTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfOptimizedMicroGridMarketMarketRuns typedSrc = (SequenceOfOptimizedMicroGridMarketMarketRuns) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.MarketRunTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.MarketRunTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.marketmodule.MaxLengthOptimizedMicroGridMarketMarketRuns.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfOptimizedMicroGridMarketMarketRuns typedDst = (SequenceOfOptimizedMicroGridMarketMarketRuns) dst;
            org.openfmb.model.dds.rti.openfmb.marketmodule.MarketRunTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.marketmodule.MaxLengthOptimizedMicroGridMarketMarketRuns.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.MarketRunTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfOptimizedMicroGridMarketMarketRuns typedDst = (SequenceOfOptimizedMicroGridMarketMarketRuns) sample;
    ...
    protected SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfOptimizedMicroGridMarketMarketRunsTypeCode.VALUE,SequenceOfOptimizedMicroGridMarketMarketRuns.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfOptimizedMicroGridMarketMarketRunsTypeCode.VALUE,SequenceOfOptimizedMicroGridMarketMarketRuns.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
