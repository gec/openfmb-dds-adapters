...
public class BatterySystemTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::BatterySystem";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatterySystemTypeSupport _singleton
    = new BatterySystemTypeSupport();
    ...
    */
    public static BatterySystemTypeSupport get_instance() {
        return _singleton;
    }

    public static BatterySystemTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatterySystemTypeCode.VALUE;
    }

    public Object create_data() {
        return BatterySystem.create();
    }
    ...
    * <code>this</code> is not a <code>BatterySystem</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatterySystem typedDst = (BatterySystem) destination;
        BatterySystem typedSrc = (BatterySystem) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatterySystem typedSrc = (BatterySystem) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatterySystem typedDst = (BatterySystem) sample;
    ...
    protected BatterySystemTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatterySystemTypeCode.VALUE,BatterySystem.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatterySystemTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatterySystemTypeCode.VALUE,BatterySystem.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
