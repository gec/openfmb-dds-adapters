...
/**
* A sequence of RecloserControl instances.
*/
public final class RecloserControlSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RecloserControlSeq() {
        super(RecloserControl.class);
    }

    public RecloserControlSeq (int initialMaximum) {
        super(RecloserControl.class, initialMaximum);
    }

    public RecloserControlSeq (Collection elements) {
        super(RecloserControl.class, elements);
    }
