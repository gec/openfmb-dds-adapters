...
/**
* A sequence of Curve instances.
*/
public final class CurveSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public CurveSeq (int initialMaximum) {
        super(Curve.class, initialMaximum);
    }

    public CurveSeq (Collection elements) {
        super(Curve.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Curve objects (beyond the original size of this object)
