...
* GenerationReadingModule
*/

public class GenerationReadingModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationReadingModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationReadingModuleTypeSupport _singleton
    = new GenerationReadingModuleTypeSupport();
    ...
    */
    public static GenerationReadingModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationReadingModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationReadingModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationReadingModule.create();
    }
    ...
    public Object create_key() {
        return new GenerationReadingModule();
    }
    ...
    public Class get_type() {
        return GenerationReadingModule.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationReadingModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationReadingModule typedDst = (GenerationReadingModule) destination;
        GenerationReadingModule typedSrc = (GenerationReadingModule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationReadingsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationReadingsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationReadingModule typedSrc = (GenerationReadingModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationReadingsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationReadingsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.readings, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationReadingModule typedDst = (GenerationReadingModule) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.readings = (org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationReadings)org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationReadingsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.readings, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationReadingsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationReadingModule typedDst = (GenerationReadingModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationReadingModule typedDst
        = (GenerationReadingModule) instance;
        GenerationReadingModule typedSrc
        = (GenerationReadingModule) key;
    ...
    */
    ...
    int mask) {
        return new GenerationReadingModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationReadingModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationReadingModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationReadingModuleTypeCode.VALUE,GenerationReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationReadingModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationReadingModuleTypeCode.VALUE,GenerationReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
