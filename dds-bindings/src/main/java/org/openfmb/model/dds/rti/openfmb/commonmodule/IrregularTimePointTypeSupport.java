...
public class IrregularTimePointTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::IrregularTimePoint";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final IrregularTimePointTypeSupport _singleton
    = new IrregularTimePointTypeSupport();
    ...
    */
    public static IrregularTimePointTypeSupport get_instance() {
        return _singleton;
    }

    public static IrregularTimePointTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return IrregularTimePointTypeCode.VALUE;
    }

    public Object create_data() {
        return IrregularTimePoint.create();
    }
    ...
    public Class get_type() {
        return IrregularTimePoint.class;
    }
    ...
    * <code>this</code> is not a <code>IrregularTimePoint</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        IrregularTimePoint typedDst = (IrregularTimePoint) destination;
        IrregularTimePoint typedSrc = (IrregularTimePoint) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        IrregularTimePoint typedSrc = (IrregularTimePoint) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeFloat(typedSrc.value1);

            dst.writeFloat(typedSrc.value2);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            IrregularTimePoint typedDst = (IrregularTimePoint) dst;
            typedDst.clear();      
            try{
                typedDst.value1 = src.readFloat();
                typedDst.value2 = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            IrregularTimePoint typedDst = (IrregularTimePoint) sample;
    ...
    protected IrregularTimePointTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,IrregularTimePointTypeCode.VALUE,IrregularTimePoint.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected IrregularTimePointTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,IrregularTimePointTypeCode.VALUE,IrregularTimePoint.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
