...
public class SolarCapability   implements Copyable, Serializable{
    ...
    public float ahrRtg= 0;
    public String qualityFlag=  "" ; /* maximum length = (255) */
    public long timestamp= 0;
    public float voltage= 0;
    public float wRtgMaxVal= 0;
    public float wRtgMinVal= 0;
    ...
    public boolean equals(Object o) {
        ...
        if(wRtgMaxVal != otherObj.wRtgMaxVal) {
            return false;
        }
        if(wRtgMinVal != otherObj.wRtgMinVal) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        __result += (int)wRtgMaxVal;
        __result += (int)wRtgMinVal;
        return __result;
    }
