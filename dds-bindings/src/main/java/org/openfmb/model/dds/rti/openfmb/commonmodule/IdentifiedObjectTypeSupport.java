...
public class IdentifiedObjectTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::IdentifiedObject";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final IdentifiedObjectTypeSupport _singleton
    = new IdentifiedObjectTypeSupport();
    ...
    */
    public static IdentifiedObjectTypeSupport get_instance() {
        return _singleton;
    }

    public static IdentifiedObjectTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return IdentifiedObjectTypeCode.VALUE;
    }

    public Object create_data() {
        return IdentifiedObject.create();
    }
    ...
    * <code>this</code> is not a <code>IdentifiedObject</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        IdentifiedObject typedDst = (IdentifiedObject) destination;
        IdentifiedObject typedSrc = (IdentifiedObject) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        IdentifiedObject typedSrc = (IdentifiedObject) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            IdentifiedObject typedDst = (IdentifiedObject) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            IdentifiedObject typedDst = (IdentifiedObject) sample;
    ...
    protected IdentifiedObjectTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,IdentifiedObjectTypeCode.VALUE,IdentifiedObject.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected IdentifiedObjectTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,IdentifiedObjectTypeCode.VALUE,IdentifiedObject.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
