...
public class LoadReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::LoadReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadReadingProfileTypeSupport _singleton
    = new LoadReadingProfileTypeSupport();
    ...
    */
    public static LoadReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadReadingProfile.create();
    }
    ...
    public Class get_type() {
        return LoadReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>LoadReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadReadingProfile typedDst = (LoadReadingProfile) destination;
        LoadReadingProfile typedSrc = (LoadReadingProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadReadingsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadReadingsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LoadReadingProfile typedSrc = (LoadReadingProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadReadingsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadReadingsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.readings, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadReadingProfile typedDst = (LoadReadingProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.readings = (org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadReadings)org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadReadingsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.readings, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadReadingsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadReadingProfile typedDst = (LoadReadingProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        LoadReadingProfile typedDst
        = (LoadReadingProfile) instance;
        LoadReadingProfile typedSrc
        = (LoadReadingProfile) key;
    ...
    */
    ...
    int mask) {
        return new LoadReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LoadReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected LoadReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,LoadReadingProfileTypeCode.VALUE,LoadReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadReadingProfileTypeCode.VALUE,LoadReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
