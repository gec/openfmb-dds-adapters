...
/**
* A sequence of ReadingType instances.
*/
public final class ReadingTypeSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ReadingTypeSeq() {
        super(ReadingType.class);
    }

    public ReadingTypeSeq (int initialMaximum) {
        super(ReadingType.class, initialMaximum);
    }

    public ReadingTypeSeq (Collection elements) {
        super(ReadingType.class, elements);
    }
