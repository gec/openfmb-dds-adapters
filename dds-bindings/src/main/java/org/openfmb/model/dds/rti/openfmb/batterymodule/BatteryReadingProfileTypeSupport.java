...
public class BatteryReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::BatteryReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryReadingProfileTypeSupport _singleton
    = new BatteryReadingProfileTypeSupport();
    ...
    */
    public static BatteryReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryReadingProfile.create();
    }
    ...
    public Class get_type() {
        return BatteryReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryReadingProfile typedDst = (BatteryReadingProfile) destination;
        BatteryReadingProfile typedSrc = (BatteryReadingProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryReadingProfile typedSrc = (BatteryReadingProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryReadingProfile typedDst = (BatteryReadingProfile) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryReadingProfile typedDst = (BatteryReadingProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BatteryReadingProfile typedDst
        = (BatteryReadingProfile) instance;
        BatteryReadingProfile typedSrc
        = (BatteryReadingProfile) key;
    ...
    */
    ...
    int mask) {
        return new BatteryReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BatteryReadingProfileTypeCode.VALUE,BatteryReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryReadingProfileTypeCode.VALUE,BatteryReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
