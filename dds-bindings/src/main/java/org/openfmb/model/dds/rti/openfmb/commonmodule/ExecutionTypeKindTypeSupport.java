...
public class ExecutionTypeKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::ExecutionTypeKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ExecutionTypeKindTypeSupport _singleton
    = new ExecutionTypeKindTypeSupport();
    ...
    */
    public static ExecutionTypeKindTypeSupport get_instance() {
        return _singleton;
    }

    public static ExecutionTypeKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ExecutionTypeKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return ExecutionTypeKind.class;
    }
    ...
    * <code>this</code> is not a <code>ExecutionTypeKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        ExecutionTypeKind typedSrc = (ExecutionTypeKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = ExecutionTypeKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected ExecutionTypeKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ExecutionTypeKindTypeCode.VALUE,ExecutionTypeKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
