...
/**
* A sequence of SunRadiation instances.
*/
public final class SunRadiationSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SunRadiationSeq() {
        super(SunRadiation.class);
    }

    public SunRadiationSeq (int initialMaximum) {
        super(SunRadiation.class, initialMaximum);
    }

    public SunRadiationSeq (Collection elements) {
        super(SunRadiation.class, elements);
    }
