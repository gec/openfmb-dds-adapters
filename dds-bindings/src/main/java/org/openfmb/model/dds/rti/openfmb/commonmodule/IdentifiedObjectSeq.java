...
/**
* A sequence of IdentifiedObject instances.
*/
public final class IdentifiedObjectSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public IdentifiedObjectSeq() {
        super(IdentifiedObject.class);
    }

    public IdentifiedObjectSeq (int initialMaximum) {
        super(IdentifiedObject.class, initialMaximum);
    }

    public IdentifiedObjectSeq (Collection elements) {
        super(IdentifiedObject.class, elements);
    }
