...
public class SecurityEventModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::securitymodule::SecurityEventModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SecurityEventModuleTypeSupport _singleton
    = new SecurityEventModuleTypeSupport();
    ...
    */
    public static SecurityEventModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static SecurityEventModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SecurityEventModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return SecurityEventModule.create();
    }
    ...
    public Object create_key() {
        return new SecurityEventModule();
    }
    ...
    public Class get_type() {
        return SecurityEventModule.class;
    }
    ...
    * <code>this</code> is not a <code>SecurityEventModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SecurityEventModule typedDst = (SecurityEventModule) destination;
        SecurityEventModule typedSrc = (SecurityEventModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SecurityEventModule typedSrc = (SecurityEventModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SecurityEventModule typedDst = (SecurityEventModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SecurityEventModule typedDst = (SecurityEventModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SecurityEventModule typedDst
        = (SecurityEventModule) instance;
        SecurityEventModule typedSrc
        = (SecurityEventModule) key;
    ...
    */
    ...
    int mask) {
        return new SecurityEventModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SecurityEventModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected SecurityEventModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SecurityEventModuleTypeCode.VALUE,SecurityEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SecurityEventModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SecurityEventModuleTypeCode.VALUE,SecurityEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
