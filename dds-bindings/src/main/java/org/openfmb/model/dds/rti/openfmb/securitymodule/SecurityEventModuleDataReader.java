...
/**
* A reader for the SecurityEventModule user type.
*/
public class SecurityEventModuleDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(SecurityEventModuleSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    ...
    public void take(SecurityEventModuleSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(SecurityEventModuleSeq received_data, 
    ...
    public void take_w_condition(SecurityEventModuleSeq received_data, 
    SampleInfoSeq info_seq,
    int max_samples,
    ReadCondition condition) {
    ...
    public void read_next_sample(SecurityEventModule received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }

    public void take_next_sample(SecurityEventModule received_data, SampleInfo sample_info) {
        take_next_sample_untyped(received_data, sample_info);
    }

    public void read_instance(SecurityEventModuleSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(SecurityEventModuleSeq received_data, SampleInfoSeq info_seq,
    int max_samples, InstanceHandle_t a_handle, int sample_states,
    int view_states, int instance_states) {
    ...
    public void read_instance_w_condition(SecurityEventModuleSeq received_data,
    ...
    public void take_instance_w_condition(SecurityEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void read_next_instance(SecurityEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance(SecurityEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, int sample_states, int view_states,
    int instance_states) {
    ...
    public void read_next_instance_w_condition(SecurityEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void take_next_instance_w_condition(SecurityEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(SecurityEventModuleSeq received_data, SampleInfoSeq info_seq) {
    ...
    /*package*/  SecurityEventModuleDataReader (long native_reader, DataReaderListener listener,
