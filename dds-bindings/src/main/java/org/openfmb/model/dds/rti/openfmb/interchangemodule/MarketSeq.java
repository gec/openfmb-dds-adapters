...
/**
* A sequence of Market instances.
*/
public final class MarketSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MarketSeq (int initialMaximum) {
        super(Market.class, initialMaximum);
    }

    public MarketSeq (Collection elements) {
        super(Market.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Market objects (beyond the original size of this object)
