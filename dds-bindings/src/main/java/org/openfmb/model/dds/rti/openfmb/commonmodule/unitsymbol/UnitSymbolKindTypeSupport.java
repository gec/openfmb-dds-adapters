...
public class UnitSymbolKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::unitsymbol::UnitSymbolKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final UnitSymbolKindTypeSupport _singleton
    = new UnitSymbolKindTypeSupport();
    ...
    */
    public static UnitSymbolKindTypeSupport get_instance() {
        return _singleton;
    }

    public static UnitSymbolKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return UnitSymbolKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>UnitSymbolKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        UnitSymbolKind typedSrc = (UnitSymbolKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = UnitSymbolKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected UnitSymbolKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,UnitSymbolKindTypeCode.VALUE,UnitSymbolKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
