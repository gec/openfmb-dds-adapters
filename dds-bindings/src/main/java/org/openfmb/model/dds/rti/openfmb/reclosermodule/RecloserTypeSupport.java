...
public class RecloserTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::Recloser";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserTypeSupport _singleton
    = new RecloserTypeSupport();
    ...
    */
    public static RecloserTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserTypeCode.VALUE;
    }

    public Object create_data() {
        return Recloser.create();
    }
    ...
    * <code>this</code> is not a <code>Recloser</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Recloser typedDst = (Recloser) destination;
        Recloser typedSrc = (Recloser) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Recloser typedSrc = (Recloser) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.normalOpen);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Recloser typedDst = (Recloser) sample;
    ...
    protected RecloserTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,RecloserTypeCode.VALUE,Recloser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserTypeCode.VALUE,Recloser.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
