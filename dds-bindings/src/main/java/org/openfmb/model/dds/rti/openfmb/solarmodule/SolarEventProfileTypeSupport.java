...
public class SolarEventProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarEventProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarEventProfileTypeSupport _singleton
    = new SolarEventProfileTypeSupport();
    ...
    */
    public static SolarEventProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarEventProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarEventProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarEventProfile.create();
    }
    ...
    public Class get_type() {
        return SolarEventProfile.class;
    }
    ...
    * <code>this</code> is not a <code>SolarEventProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarEventProfile typedDst = (SolarEventProfile) destination;
        SolarEventProfile typedSrc = (SolarEventProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarEventProfile typedSrc = (SolarEventProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    */
    ...
    int mask) {
        return new SolarEventProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarEventProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarEventProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarEventProfileTypeCode.VALUE,SolarEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarEventProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarEventProfileTypeCode.VALUE,SolarEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
