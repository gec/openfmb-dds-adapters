...
public class BatteryControlModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::BatteryControlModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryControlModuleTypeSupport _singleton
    = new BatteryControlModuleTypeSupport();
    ...
    */
    public static BatteryControlModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryControlModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryControlModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryControlModule.create();
    }
    ...
    public Object create_key() {
        return new BatteryControlModule();
    }
    ...
    public Class get_type() {
        return BatteryControlModule.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryControlModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryControlModule typedDst = (BatteryControlModule) destination;
        BatteryControlModule typedSrc = (BatteryControlModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryControlModule typedSrc = (BatteryControlModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryControlModule typedDst = (BatteryControlModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryControlModule typedDst = (BatteryControlModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BatteryControlModule typedDst
        = (BatteryControlModule) instance;
        BatteryControlModule typedSrc
        = (BatteryControlModule) key;
    ...
    */
    ...
    int mask) {
        return new BatteryControlModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryControlModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryControlModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BatteryControlModuleTypeCode.VALUE,BatteryControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryControlModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryControlModuleTypeCode.VALUE,BatteryControlModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
