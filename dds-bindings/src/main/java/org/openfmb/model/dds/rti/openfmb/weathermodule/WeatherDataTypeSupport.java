...
public class WeatherDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::WeatherData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WeatherDataTypeSupport _singleton
    = new WeatherDataTypeSupport();
    ...
    */
    public static WeatherDataTypeSupport get_instance() {
        return _singleton;
    }

    public static WeatherDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WeatherDataTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>WeatherData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        WeatherData typedDst = (WeatherData) destination;
        WeatherData typedSrc = (WeatherData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.WindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.WindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        WeatherData typedSrc = (WeatherData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.HumidityTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.humidity);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.sunRadiation);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.temperature);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.WindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.wind);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.versionDateTime);

            org.openfmb.model.dds.rti.openfmb.weathermodule.HumidityTypeSupport.get_instance().serialize(endpoint_data, typedSrc.humidity, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationTypeSupport.get_instance().serialize(endpoint_data, typedSrc.sunRadiation, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureTypeSupport.get_instance().serialize(endpoint_data, typedSrc.temperature, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.weathermodule.WindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.wind, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.sunRadiation = (org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiation)org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.sunRadiation, src, false, true, endpoint_plugin_qos);     
                typedDst.temperature = (org.openfmb.model.dds.rti.openfmb.weathermodule.Temperature)org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.temperature, src, false, true, endpoint_plugin_qos);     
                typedDst.wind = (org.openfmb.model.dds.rti.openfmb.weathermodule.Wind)org.openfmb.model.dds.rti.openfmb.weathermodule.WindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.wind, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.HumidityTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.weathermodule.SunRadiationTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.weathermodule.WindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            WeatherData typedDst = (WeatherData) sample;
    ...
    protected WeatherDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WeatherDataTypeCode.VALUE,WeatherData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WeatherDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WeatherDataTypeCode.VALUE,WeatherData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
