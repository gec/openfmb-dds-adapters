...
* SequenceOfGenerationReadings
*/

public class SequenceOfGenerationReadingsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::SequenceOfGenerationReadings";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfGenerationReadingsTypeSupport _singleton
    = new SequenceOfGenerationReadingsTypeSupport();
    ...
    */
    public static SequenceOfGenerationReadingsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfGenerationReadingsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfGenerationReadingsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfGenerationReadings.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfGenerationReadings();
    }
    ...
    public Class get_type() {
        return SequenceOfGenerationReadings.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfGenerationReadings</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfGenerationReadings typedDst = (SequenceOfGenerationReadings) destination;
        SequenceOfGenerationReadings typedSrc = (SequenceOfGenerationReadings) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.generationmodule.MaxLengthGenerationReadings.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfGenerationReadings typedSrc = (SequenceOfGenerationReadings) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.generationmodule.MaxLengthGenerationReadings.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfGenerationReadings typedDst = (SequenceOfGenerationReadings) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.generationmodule.MaxLengthGenerationReadings.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfGenerationReadings typedDst = (SequenceOfGenerationReadings) sample;
    ...
    protected SequenceOfGenerationReadingsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfGenerationReadingsTypeCode.VALUE,SequenceOfGenerationReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfGenerationReadingsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfGenerationReadingsTypeCode.VALUE,SequenceOfGenerationReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
