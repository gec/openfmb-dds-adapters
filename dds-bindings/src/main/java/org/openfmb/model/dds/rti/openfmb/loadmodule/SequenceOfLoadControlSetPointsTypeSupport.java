...
* SequenceOfLoadControlSetPoints
*/

public class SequenceOfLoadControlSetPointsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::SequenceOfLoadControlSetPoints";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfLoadControlSetPointsTypeSupport _singleton
    = new SequenceOfLoadControlSetPointsTypeSupport();
    ...
    */
    public static SequenceOfLoadControlSetPointsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfLoadControlSetPointsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfLoadControlSetPointsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfLoadControlSetPoints.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfLoadControlSetPoints();
    }
    ...
    public Class get_type() {
        return SequenceOfLoadControlSetPoints.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfLoadControlSetPoints</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfLoadControlSetPoints typedDst = (SequenceOfLoadControlSetPoints) destination;
        SequenceOfLoadControlSetPoints typedSrc = (SequenceOfLoadControlSetPoints) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadControlSetPoints.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfLoadControlSetPoints typedSrc = (SequenceOfLoadControlSetPoints) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadControlSetPoints.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfLoadControlSetPoints typedDst = (SequenceOfLoadControlSetPoints) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadControlSetPoints.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfLoadControlSetPoints typedDst = (SequenceOfLoadControlSetPoints) sample;
    ...
    protected SequenceOfLoadControlSetPointsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfLoadControlSetPointsTypeCode.VALUE,SequenceOfLoadControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfLoadControlSetPointsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfLoadControlSetPointsTypeCode.VALUE,SequenceOfLoadControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
