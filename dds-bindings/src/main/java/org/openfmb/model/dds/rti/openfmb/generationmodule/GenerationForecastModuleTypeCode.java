...
public class  GenerationForecastModuleTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("generatingUnit", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.openfmb.generationmodule.GeneratingUnitTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("openfmb::generationmodule::GenerationForecastModule",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
