...
public class ForecastScheduleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::ForecastSchedule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ForecastScheduleTypeSupport _singleton
    = new ForecastScheduleTypeSupport();
    ...
    */
    public static ForecastScheduleTypeSupport get_instance() {
        return _singleton;
    }

    public static ForecastScheduleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ForecastScheduleTypeCode.VALUE;
    }

    public Object create_data() {
        return ForecastSchedule.create();
    }
    ...
    * <code>this</code> is not a <code>ForecastSchedule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ForecastSchedule typedDst = (ForecastSchedule) destination;
        ForecastSchedule typedSrc = (ForecastSchedule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ForecastSchedule typedSrc = (ForecastSchedule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfForecastScheduleIrregularTimePointsTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.irregularTimePoints);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfForecastScheduleIrregularTimePointsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.irregularTimePoints, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SequenceOfForecastScheduleIrregularTimePointsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ForecastSchedule typedDst = (ForecastSchedule) sample;
    ...
    protected ForecastScheduleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ForecastScheduleTypeCode.VALUE,ForecastSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ForecastScheduleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ForecastScheduleTypeCode.VALUE,ForecastSchedule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
