...
/**
* A sequence of SecurityEvent instances.
*/
public final class SecurityEventSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SecurityEventSeq() {
        super(SecurityEvent.class);
    }

    public SecurityEventSeq (int initialMaximum) {
        super(SecurityEvent.class, initialMaximum);
    }

    public SecurityEventSeq (Collection elements) {
        super(SecurityEvent.class, elements);
    }
