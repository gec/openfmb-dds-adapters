...
public class CurveStyleKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::CurveStyleKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final CurveStyleKindTypeSupport _singleton
    = new CurveStyleKindTypeSupport();
    ...
    */
    public static CurveStyleKindTypeSupport get_instance() {
        return _singleton;
    }

    public static CurveStyleKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return CurveStyleKindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>CurveStyleKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        CurveStyleKind typedSrc = (CurveStyleKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = CurveStyleKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected CurveStyleKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,CurveStyleKindTypeCode.VALUE,CurveStyleKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
