...
* InterchangeScheduleModule
*/

public class InterchangeScheduleModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::InterchangeScheduleModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final InterchangeScheduleModuleTypeSupport _singleton
    = new InterchangeScheduleModuleTypeSupport();
    ...
    */
    public static InterchangeScheduleModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static InterchangeScheduleModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return InterchangeScheduleModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return InterchangeScheduleModule.create();
    }
    ...
    public Object create_key() {
        return new InterchangeScheduleModule();
    }
    ...
    public Class get_type() {
        return InterchangeScheduleModule.class;
    }
    ...
    * <code>this</code> is not a <code>InterchangeScheduleModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        InterchangeScheduleModule typedDst = (InterchangeScheduleModule) destination;
        InterchangeScheduleModule typedSrc = (InterchangeScheduleModule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.InterchangeScheduleTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.InterchangeScheduleTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        InterchangeScheduleModule typedSrc = (InterchangeScheduleModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.scheduleID );
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.InterchangeScheduleTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.interchangeSchedule);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.powerSystemResource);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.scheduleID,(255));

            dst.writeLong(typedSrc.timestamp);

            org.openfmb.model.dds.rti.openfmb.marketmodule.InterchangeScheduleTypeSupport.get_instance().serialize(endpoint_data, typedSrc.interchangeSchedule, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().serialize(endpoint_data, typedSrc.powerSystemResource, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            InterchangeScheduleModule typedDst = (InterchangeScheduleModule) dst;
            typedDst.clear();      
            try{
                typedDst.scheduleID = src.readString((255));
                typedDst.timestamp = src.readLong();
                typedDst.interchangeSchedule = (org.openfmb.model.dds.rti.openfmb.marketmodule.InterchangeSchedule)org.openfmb.model.dds.rti.openfmb.marketmodule.InterchangeScheduleTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.interchangeSchedule, src, false, true, endpoint_plugin_qos);     
                typedDst.powerSystemResource = (org.openfmb.model.dds.rti.openfmb.commonmodule.PowerSystemResource)org.openfmb.model.dds.rti.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.powerSystemResource, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.InterchangeScheduleTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.commonmodule.PowerSystemResourceTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            InterchangeScheduleModule typedDst = (InterchangeScheduleModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        InterchangeScheduleModule typedDst
        = (InterchangeScheduleModule) instance;
        InterchangeScheduleModule typedSrc
        = (InterchangeScheduleModule) key;
    ...
    */
    ...
    int mask) {
        return new InterchangeScheduleModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new InterchangeScheduleModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected InterchangeScheduleModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,InterchangeScheduleModuleTypeCode.VALUE,InterchangeScheduleModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected InterchangeScheduleModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,InterchangeScheduleModuleTypeCode.VALUE,InterchangeScheduleModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
