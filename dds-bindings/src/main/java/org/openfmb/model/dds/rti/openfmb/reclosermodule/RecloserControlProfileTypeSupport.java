...
public class RecloserControlProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::RecloserControlProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserControlProfileTypeSupport _singleton
    = new RecloserControlProfileTypeSupport();
    ...
    */
    public static RecloserControlProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserControlProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserControlProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserControlProfile.create();
    }
    ...
    public Class get_type() {
        return RecloserControlProfile.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserControlProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserControlProfile typedDst = (RecloserControlProfile) destination;
        RecloserControlProfile typedSrc = (RecloserControlProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserControlTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserControlTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RecloserControlProfile typedSrc = (RecloserControlProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserControlTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.recloserControl);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserControlTypeSupport.get_instance().serialize(endpoint_data, typedSrc.recloserControl, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserControlProfile typedDst = (RecloserControlProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.recloserControl = (org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserControl)org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserControlTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.recloserControl, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserControlTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserControlProfile typedDst = (RecloserControlProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RecloserControlProfile typedDst
        = (RecloserControlProfile) instance;
        RecloserControlProfile typedSrc
        = (RecloserControlProfile) key;
    ...
    */
    ...
    int mask) {
        return new RecloserControlProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RecloserControlProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected RecloserControlProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RecloserControlProfileTypeCode.VALUE,RecloserControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserControlProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserControlProfileTypeCode.VALUE,RecloserControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
