...
public class SolarReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarReadingProfileTypeSupport _singleton
    = new SolarReadingProfileTypeSupport();
    ...
    */
    public static SolarReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarReadingProfile.create();
    }
    ...
    public Class get_type() {
        return SolarReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>SolarReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarReadingProfile typedDst = (SolarReadingProfile) destination;
        SolarReadingProfile typedSrc = (SolarReadingProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarReadingsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarReadingsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarReadingProfile typedSrc = (SolarReadingProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarReadingsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarReadingsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.readings, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarReadingProfile typedDst = (SolarReadingProfile) dst;
            typedDst.clear();      
            try{
                typedDst.logicalDeviceID = src.readString((255));
                typedDst.timestamp = src.readLong();
                typedDst.readings = (org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarReadings)org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarReadingsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.readings, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarReadingsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarReadingProfile typedDst = (SolarReadingProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarReadingProfile typedDst
        = (SolarReadingProfile) instance;
        SolarReadingProfile typedSrc
        = (SolarReadingProfile) key;
    ...
    */
    ...
    int mask) {
        return new SolarReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarReadingProfileTypeCode.VALUE,SolarReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarReadingProfileTypeCode.VALUE,SolarReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
