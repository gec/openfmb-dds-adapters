...
public class GenerationControlTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationControl";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationControlTypeSupport _singleton
    = new GenerationControlTypeSupport();
    ...
    */
    public static GenerationControlTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationControlTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationControlTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationControl.create();
    }
    ...
    public Class get_type() {
        return GenerationControl.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationControl</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationControl typedDst = (GenerationControl) destination;
        GenerationControl typedSrc = (GenerationControl) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationControlSetPointsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationControlSetPointsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationControl typedSrc = (GenerationControl) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationControlSetPointsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationControlSetPointsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.setPoints, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationControl typedDst = (GenerationControl) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.setPoints = (org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationControlSetPoints)org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationControlSetPointsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.setPoints, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.generationmodule.SequenceOfGenerationControlSetPointsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationControl typedDst = (GenerationControl) sample;
    ...
    protected GenerationControlTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationControlTypeCode.VALUE,GenerationControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationControlTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationControlTypeCode.VALUE,GenerationControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
