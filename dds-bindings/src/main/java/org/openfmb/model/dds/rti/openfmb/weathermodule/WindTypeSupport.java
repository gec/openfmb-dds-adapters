...
public class WindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::Wind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final WindTypeSupport _singleton
    = new WindTypeSupport();
    ...
    */
    public static WindTypeSupport get_instance() {
        return _singleton;
    }

    public static WindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return WindTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Wind</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Wind typedDst = (Wind) destination;
        Wind typedSrc = (Wind) source;
    ...
    protected WindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,WindTypeCode.VALUE,Wind.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected WindTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,WindTypeCode.VALUE,Wind.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
