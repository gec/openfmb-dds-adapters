...
* SequenceOfBatteryReadings
*/

public class SequenceOfBatteryReadingsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::SequenceOfBatteryReadings";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfBatteryReadingsTypeSupport _singleton
    = new SequenceOfBatteryReadingsTypeSupport();
    ...
    */
    public static SequenceOfBatteryReadingsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfBatteryReadingsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfBatteryReadingsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfBatteryReadings.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfBatteryReadings();
    }
    ...
    public Class get_type() {
        return SequenceOfBatteryReadings.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfBatteryReadings</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfBatteryReadings typedDst = (SequenceOfBatteryReadings) destination;
        SequenceOfBatteryReadings typedSrc = (SequenceOfBatteryReadings) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.batterymodule.MaxLengthBatteryReadings.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfBatteryReadings typedSrc = (SequenceOfBatteryReadings) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.batterymodule.MaxLengthBatteryReadings.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfBatteryReadings typedDst = (SequenceOfBatteryReadings) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.batterymodule.MaxLengthBatteryReadings.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfBatteryReadings typedDst = (SequenceOfBatteryReadings) sample;
    ...
    protected SequenceOfBatteryReadingsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfBatteryReadingsTypeCode.VALUE,SequenceOfBatteryReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfBatteryReadingsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfBatteryReadingsTypeCode.VALUE,SequenceOfBatteryReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
