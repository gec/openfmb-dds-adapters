...
* SequenceOfHumidityData
*/

public class SequenceOfHumidityDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::SequenceOfHumidityData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfHumidityDataTypeSupport _singleton
    = new SequenceOfHumidityDataTypeSupport();
    ...
    */
    public static SequenceOfHumidityDataTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfHumidityDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfHumidityDataTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfHumidityData.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfHumidityData();
    }
    ...
    public Class get_type() {
        return SequenceOfHumidityData.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfHumidityData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfHumidityData typedDst = (SequenceOfHumidityData) destination;
        SequenceOfHumidityData typedSrc = (SequenceOfHumidityData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.HumidityDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthHumidityData.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.HumidityDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfHumidityData typedSrc = (SequenceOfHumidityData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.HumidityDataTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.HumidityDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthHumidityData.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfHumidityData typedDst = (SequenceOfHumidityData) dst;
            org.openfmb.model.dds.rti.openfmb.weathermodule.HumidityDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthHumidityData.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.HumidityDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfHumidityData typedDst = (SequenceOfHumidityData) sample;
    ...
    protected SequenceOfHumidityDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfHumidityDataTypeCode.VALUE,SequenceOfHumidityData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfHumidityDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfHumidityDataTypeCode.VALUE,SequenceOfHumidityData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
