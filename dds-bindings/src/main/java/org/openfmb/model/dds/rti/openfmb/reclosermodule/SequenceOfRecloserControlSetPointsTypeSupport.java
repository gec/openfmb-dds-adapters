...
* SequenceOfRecloserControlSetPoints
*/

public class SequenceOfRecloserControlSetPointsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::SequenceOfRecloserControlSetPoints";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfRecloserControlSetPointsTypeSupport _singleton
    = new SequenceOfRecloserControlSetPointsTypeSupport();
    ...
    */
    public static SequenceOfRecloserControlSetPointsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfRecloserControlSetPointsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfRecloserControlSetPointsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfRecloserControlSetPoints.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfRecloserControlSetPoints();
    }
    ...
    public Class get_type() {
        return SequenceOfRecloserControlSetPoints.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfRecloserControlSetPoints</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfRecloserControlSetPoints typedDst = (SequenceOfRecloserControlSetPoints) destination;
        SequenceOfRecloserControlSetPoints typedSrc = (SequenceOfRecloserControlSetPoints) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.reclosermodule.MaxLengthRecloserControlSetPoints.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfRecloserControlSetPoints typedSrc = (SequenceOfRecloserControlSetPoints) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.reclosermodule.MaxLengthRecloserControlSetPoints.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfRecloserControlSetPoints typedDst = (SequenceOfRecloserControlSetPoints) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.reclosermodule.MaxLengthRecloserControlSetPoints.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfRecloserControlSetPoints typedDst = (SequenceOfRecloserControlSetPoints) sample;
    ...
    protected SequenceOfRecloserControlSetPointsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfRecloserControlSetPointsTypeCode.VALUE,SequenceOfRecloserControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfRecloserControlSetPointsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfRecloserControlSetPointsTypeCode.VALUE,SequenceOfRecloserControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
