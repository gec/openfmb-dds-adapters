...
public class GenerationForecastProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationForecastProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationForecastProfileTypeSupport _singleton
    = new GenerationForecastProfileTypeSupport();
    ...
    */
    public static GenerationForecastProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationForecastProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationForecastProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationForecastProfile.create();
    }
    ...
    public Class get_type() {
        return GenerationForecastProfile.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationForecastProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationForecastProfile typedDst = (GenerationForecastProfile) destination;
        GenerationForecastProfile typedSrc = (GenerationForecastProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationForecastProfile typedSrc = (GenerationForecastProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationForecastProfile typedDst = (GenerationForecastProfile) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationForecastProfile typedDst = (GenerationForecastProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationForecastProfile typedDst
        = (GenerationForecastProfile) instance;
        GenerationForecastProfile typedSrc
        = (GenerationForecastProfile) key;
    ...
    */
    ...
    int mask) {
        return new GenerationForecastProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationForecastProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationForecastProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationForecastProfileTypeCode.VALUE,GenerationForecastProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationForecastProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationForecastProfileTypeCode.VALUE,GenerationForecastProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
