...
/**
* A sequence of BatteryStatus instances.
*/
public final class BatteryStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BatteryStatusSeq() {
        super(BatteryStatus.class);
    }

    public BatteryStatusSeq (int initialMaximum) {
        super(BatteryStatus.class, initialMaximum);
    }

    public BatteryStatusSeq (Collection elements) {
        super(BatteryStatus.class, elements);
    }
