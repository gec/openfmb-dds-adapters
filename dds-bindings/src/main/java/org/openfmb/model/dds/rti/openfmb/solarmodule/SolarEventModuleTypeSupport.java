...
public class SolarEventModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarEventModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarEventModuleTypeSupport _singleton
    = new SolarEventModuleTypeSupport();
    ...
    */
    public static SolarEventModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarEventModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarEventModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarEventModule.create();
    }
    ...
    * <code>this</code> is not a <code>SolarEventModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarEventModule typedDst = (SolarEventModule) destination;
        SolarEventModule typedSrc = (SolarEventModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarEventModule typedSrc = (SolarEventModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SolarInverterStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.solarInverterStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.solarmodule.SolarInverterStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.solarInverterStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarEventModule typedDst = (SolarEventModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarEventModule typedDst = (SolarEventModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarEventModule typedDst
        = (SolarEventModule) instance;
        SolarEventModule typedSrc
        = (SolarEventModule) key;
    ...
    */
    ...
    int mask) {
        return new SolarEventModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarEventModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarEventModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarEventModuleTypeCode.VALUE,SolarEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarEventModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarEventModuleTypeCode.VALUE,SolarEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
