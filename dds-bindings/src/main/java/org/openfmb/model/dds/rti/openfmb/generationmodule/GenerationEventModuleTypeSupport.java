...
* GenerationEventModule
*/

public class GenerationEventModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationEventModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationEventModuleTypeSupport _singleton
    = new GenerationEventModuleTypeSupport();
    ...
    */
    public static GenerationEventModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationEventModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationEventModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationEventModule.create();
    }
    ...
    public Object create_key() {
        return new GenerationEventModule();
    }
    ...
    public Class get_type() {
        return GenerationEventModule.class;
    }
    ...
    * <code>this</code> is not a <code>GenerationEventModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationEventModule typedDst = (GenerationEventModule) destination;
        GenerationEventModule typedSrc = (GenerationEventModule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationEventModule typedSrc = (GenerationEventModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.generationStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.generationStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationEventModule typedDst = (GenerationEventModule) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.generationStatus = (org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationStatus)org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.generationStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationEventModule typedDst = (GenerationEventModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        GenerationEventModule typedDst
        = (GenerationEventModule) instance;
        GenerationEventModule typedSrc
        = (GenerationEventModule) key;
    ...
    */
    ...
    int mask) {
        return new GenerationEventModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new GenerationEventModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected GenerationEventModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,GenerationEventModuleTypeCode.VALUE,GenerationEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationEventModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationEventModuleTypeCode.VALUE,GenerationEventModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
