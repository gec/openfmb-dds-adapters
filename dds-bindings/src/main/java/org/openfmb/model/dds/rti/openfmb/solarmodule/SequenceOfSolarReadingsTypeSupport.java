...
* SequenceOfSolarReadings
*/

public class SequenceOfSolarReadingsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SequenceOfSolarReadings";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfSolarReadingsTypeSupport _singleton
    = new SequenceOfSolarReadingsTypeSupport();
    ...
    */
    public static SequenceOfSolarReadingsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfSolarReadingsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfSolarReadingsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfSolarReadings.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfSolarReadings();
    }
    ...
    public Class get_type() {
        return SequenceOfSolarReadings.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfSolarReadings</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfSolarReadings typedDst = (SequenceOfSolarReadings) destination;
        SequenceOfSolarReadings typedSrc = (SequenceOfSolarReadings) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.solarmodule.MaxLengthSolarReadings.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfSolarReadings typedSrc = (SequenceOfSolarReadings) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.solarmodule.MaxLengthSolarReadings.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfSolarReadings typedDst = (SequenceOfSolarReadings) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.solarmodule.MaxLengthSolarReadings.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfSolarReadings typedDst = (SequenceOfSolarReadings) sample;
    ...
    protected SequenceOfSolarReadingsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfSolarReadingsTypeCode.VALUE,SequenceOfSolarReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfSolarReadingsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfSolarReadingsTypeCode.VALUE,SequenceOfSolarReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
