...
public class UnitMultiplierKind  extends Enum {
    ...
    public static final UnitMultiplierKind noMultiplier = new UnitMultiplierKind("noMultiplier", 8);
    public static final int _noMultiplier = 8;
    ...
    public static UnitMultiplierKind valueOf(int ordinal) {
        switch(ordinal) {
            ...
            case 8: return UnitMultiplierKind.noMultiplier;
