...
public class BatteryStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::BatteryStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryStatusTypeSupport _singleton
    = new BatteryStatusTypeSupport();
    ...
    */
    public static BatteryStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryStatusTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>BatteryStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryStatus typedDst = (BatteryStatus) destination;
        BatteryStatus typedSrc = (BatteryStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryStatus typedSrc = (BatteryStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.mode );
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.isCharging);

            dst.writeBoolean(typedSrc.isConnected);

            dst.writeString(typedSrc.mode,(255));

            dst.writeFloat(typedSrc.stateOfCharge);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryStatus typedDst = (BatteryStatus) dst;
            typedDst.clear();      
            try{
                typedDst.isCharging = src.readBoolean();
                typedDst.isConnected = src.readBoolean();
                typedDst.mode = src.readString((255));
                typedDst.stateOfCharge = src.readFloat();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryStatus typedDst = (BatteryStatus) sample;
    ...
    protected BatteryStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatteryStatusTypeCode.VALUE,BatteryStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryStatusTypeCode.VALUE,BatteryStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
