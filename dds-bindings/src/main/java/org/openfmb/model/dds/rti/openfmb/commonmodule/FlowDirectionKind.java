...
public class FlowDirectionKind  extends Enum {
    ...
    public static final FlowDirectionKind noDirection = new FlowDirectionKind("noDirection", 4);
    public static final int _noDirection = 4;
    ...
    public static FlowDirectionKind valueOf(int ordinal) {
        switch(ordinal) {
            ...
            case 4: return FlowDirectionKind.noDirection;
