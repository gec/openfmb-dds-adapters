...
public class BatteryControlProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::BatteryControlProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryControlProfileTypeSupport _singleton
    = new BatteryControlProfileTypeSupport();
    ...
    */
    public static BatteryControlProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryControlProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryControlProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryControlProfile.create();
    }
    ...
    public Class get_type() {
        return BatteryControlProfile.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryControlProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryControlProfile typedDst = (BatteryControlProfile) destination;
        BatteryControlProfile typedSrc = (BatteryControlProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemControlTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemControlTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryControlProfile typedSrc = (BatteryControlProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.batterySystem);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemControlTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.batterySystemControl);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemTypeSupport.get_instance().serialize(endpoint_data, typedSrc.batterySystem, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemControlTypeSupport.get_instance().serialize(endpoint_data, typedSrc.batterySystemControl, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryControlProfile typedDst = (BatteryControlProfile) dst;
            typedDst.clear();      
            ...
            try{
                typedDst.batterySystem = (org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystem)org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.batterySystem, src, false, true, endpoint_plugin_qos);     
                typedDst.batterySystemControl = (org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemControl)org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemControlTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.batterySystemControl, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.batterymodule.BatterySystemControlTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryControlProfile typedDst = (BatteryControlProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BatteryControlProfile typedDst
        = (BatteryControlProfile) instance;
        BatteryControlProfile typedSrc
        = (BatteryControlProfile) key;
    ...
    */
    ...
    int mask) {
        return new BatteryControlProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryControlProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryControlProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BatteryControlProfileTypeCode.VALUE,BatteryControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryControlProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryControlProfileTypeCode.VALUE,BatteryControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
