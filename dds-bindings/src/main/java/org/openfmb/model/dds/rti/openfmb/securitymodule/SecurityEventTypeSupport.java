...
public class SecurityEventTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::securitymodule::SecurityEvent";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SecurityEventTypeSupport _singleton
    = new SecurityEventTypeSupport();
    ...
    */
    public static SecurityEventTypeSupport get_instance() {
        return _singleton;
    }

    public static SecurityEventTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SecurityEventTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>SecurityEvent</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SecurityEvent typedDst = (SecurityEvent) destination;
        SecurityEvent typedSrc = (SecurityEvent) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SecurityEvent typedSrc = (SecurityEvent) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SecurityEvent typedDst = (SecurityEvent) sample;
    ...
    protected SecurityEventTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SecurityEventTypeCode.VALUE,SecurityEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SecurityEventTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SecurityEventTypeCode.VALUE,SecurityEvent.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
