...
public class StringMeasurementValueTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::StringMeasurementValue";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final StringMeasurementValueTypeSupport _singleton
    = new StringMeasurementValueTypeSupport();
    ...
    */
    public static StringMeasurementValueTypeSupport get_instance() {
        return _singleton;
    }

    public static StringMeasurementValueTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return StringMeasurementValueTypeCode.VALUE;
    }

    public Object create_data() {
        return StringMeasurementValue.create();
    }
    ...
    public Class get_type() {
        return StringMeasurementValue.class;
    }
    ...
    * <code>this</code> is not a <code>StringMeasurementValue</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        StringMeasurementValue typedDst = (StringMeasurementValue) destination;
        StringMeasurementValue typedSrc = (StringMeasurementValue) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        StringMeasurementValue typedSrc = (StringMeasurementValue) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            StringMeasurementValue typedDst = (StringMeasurementValue) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            StringMeasurementValue typedDst = (StringMeasurementValue) sample;
    ...
    protected StringMeasurementValueTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,StringMeasurementValueTypeCode.VALUE,StringMeasurementValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected StringMeasurementValueTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,StringMeasurementValueTypeCode.VALUE,StringMeasurementValue.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
