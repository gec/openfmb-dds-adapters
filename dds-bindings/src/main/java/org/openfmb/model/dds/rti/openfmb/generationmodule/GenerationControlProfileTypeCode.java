...
public class  GenerationControlProfileTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("generationControl", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.openfmb.generationmodule.GenerationControlTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("openfmb::generationmodule::GenerationControlProfile",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
