...
/**
* A sequence of EndDeviceControl instances.
*/
public final class EndDeviceControlSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EndDeviceControlSeq() {
        super(EndDeviceControl.class);
    }

    public EndDeviceControlSeq (int initialMaximum) {
        super(EndDeviceControl.class, initialMaximum);
    }

    public EndDeviceControlSeq (Collection elements) {
        super(EndDeviceControl.class, elements);
    }
