...
package org.openfmb.model.dds.rti.openfmb.commonmodule.unitsymbol;
...
/**
* A sequence of UnitSymbolKind instances.
*/
public final class UnitSymbolKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public UnitSymbolKindSeq() {
        super(UnitSymbolKind.class);
    }

    public UnitSymbolKindSeq (int initialMaximum) {
        super(UnitSymbolKind.class, initialMaximum);
    }

    public UnitSymbolKindSeq (Collection elements) {
        super(UnitSymbolKind.class, elements);
    }
