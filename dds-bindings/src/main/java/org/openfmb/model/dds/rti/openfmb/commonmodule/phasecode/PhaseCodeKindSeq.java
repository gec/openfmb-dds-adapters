...
package org.openfmb.model.dds.rti.openfmb.commonmodule.phasecode;
...
/**
* A sequence of PhaseCodeKind instances.
*/
public final class PhaseCodeKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public PhaseCodeKindSeq() {
        super(PhaseCodeKind.class);
    }

    public PhaseCodeKindSeq (int initialMaximum) {
        super(PhaseCodeKind.class, initialMaximum);
    }

    public PhaseCodeKindSeq (Collection elements) {
        super(PhaseCodeKind.class, elements);
    }
