...
* SequenceOfMarketRuns
*/

public class SequenceOfMarketRunsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::interchangemodule::SequenceOfMarketRuns";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfMarketRunsTypeSupport _singleton
    = new SequenceOfMarketRunsTypeSupport();
    ...
    */
    public static SequenceOfMarketRunsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfMarketRunsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfMarketRunsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfMarketRuns.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfMarketRuns();
    }
    ...
    public Class get_type() {
        return SequenceOfMarketRuns.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfMarketRuns</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfMarketRuns typedDst = (SequenceOfMarketRuns) destination;
        SequenceOfMarketRuns typedSrc = (SequenceOfMarketRuns) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketRunTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.interchangemodule.MaxLengthMarketRuns.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketRunTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfMarketRuns typedSrc = (SequenceOfMarketRuns) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketRunTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketRunTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.interchangemodule.MaxLengthMarketRuns.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfMarketRuns typedDst = (SequenceOfMarketRuns) dst;
            org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketRunTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.interchangemodule.MaxLengthMarketRuns.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.interchangemodule.MarketRunTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfMarketRuns typedDst = (SequenceOfMarketRuns) sample;
    ...
    protected SequenceOfMarketRunsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfMarketRunsTypeCode.VALUE,SequenceOfMarketRuns.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfMarketRunsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfMarketRunsTypeCode.VALUE,SequenceOfMarketRuns.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
