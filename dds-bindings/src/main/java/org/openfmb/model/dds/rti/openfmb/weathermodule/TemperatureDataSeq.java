...
/**
* A sequence of TemperatureData instances.
*/
public final class TemperatureDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public TemperatureDataSeq() {
        super(TemperatureData.class);
    }

    public TemperatureDataSeq (int initialMaximum) {
        super(TemperatureData.class, initialMaximum);
    }

    public TemperatureDataSeq (Collection elements) {
        super(TemperatureData.class, elements);
    }
