...
// ===========================================================================
/**
* A writer for the SolarReadingModule user type.
*/
public class SolarReadingModuleDataWriter extends DataWriterImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public InstanceHandle_t register_instance(SolarReadingModule instance_data) {
        return register_instance_untyped(instance_data);
    }

    public InstanceHandle_t register_instance_w_timestamp(SolarReadingModule instance_data,
    Time_t source_timestamp) {
        return register_instance_w_timestamp_untyped(
            instance_data, source_timestamp);
    }

    public InstanceHandle_t register_instance_w_params(SolarReadingModule instance_data,
    WriteParams_t params) {
        return register_instance_w_params_untyped(
            instance_data, params);
    }

    public void unregister_instance(SolarReadingModule instance_data,
    InstanceHandle_t handle) {
        unregister_instance_untyped(instance_data, handle);
    }

    public void unregister_instance_w_timestamp(SolarReadingModule instance_data,
    ...
    public void unregister_instance_w_params(SolarReadingModule instance_data,
    WriteParams_t params) {
    ...
    public void write(SolarReadingModule instance_data, InstanceHandle_t handle) {
        write_untyped(instance_data, handle);
    }

    public void write_w_timestamp(SolarReadingModule instance_data,
    InstanceHandle_t handle, Time_t source_timestamp) {

        write_w_timestamp_untyped(instance_data, handle, source_timestamp);
    }

    public void write_w_params(SolarReadingModule instance_data,
    WriteParams_t params) {

        write_w_params_untyped(instance_data, params);
    }

    public void dispose(SolarReadingModule instance_data, InstanceHandle_t instance_handle){
        dispose_untyped(instance_data, instance_handle);
    }

    public void dispose_w_timestamp(SolarReadingModule instance_data,
    ...
    public void dispose_w_params(SolarReadingModule instance_data,
    WriteParams_t params) {
    ...
    /*package*/ SolarReadingModuleDataWriter(long native_writer, DataWriterListener listener,
