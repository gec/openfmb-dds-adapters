...
public class LoadControlProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::LoadControlProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadControlProfileTypeSupport _singleton
    = new LoadControlProfileTypeSupport();
    ...
    */
    public static LoadControlProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadControlProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadControlProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadControlProfile.create();
    }
    ...
    public Class get_type() {
        return LoadControlProfile.class;
    }
    ...
    * <code>this</code> is not a <code>LoadControlProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadControlProfile typedDst = (LoadControlProfile) destination;
        LoadControlProfile typedSrc = (LoadControlProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LoadControlProfile typedSrc = (LoadControlProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadControlProfile typedDst = (LoadControlProfile) dst;
            typedDst.clear();      
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadControlProfile typedDst = (LoadControlProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        LoadControlProfile typedDst
        = (LoadControlProfile) instance;
        LoadControlProfile typedSrc
        = (LoadControlProfile) key;
    ...
    */
    ...
    int mask) {
        return new LoadControlProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LoadControlProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected LoadControlProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,LoadControlProfileTypeCode.VALUE,LoadControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadControlProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadControlProfileTypeCode.VALUE,LoadControlProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
