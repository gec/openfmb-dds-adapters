...
* SequenceOfSolarControlSetPoints
*/

public class SequenceOfSolarControlSetPointsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SequenceOfSolarControlSetPoints";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfSolarControlSetPointsTypeSupport _singleton
    = new SequenceOfSolarControlSetPointsTypeSupport();
    ...
    */
    public static SequenceOfSolarControlSetPointsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfSolarControlSetPointsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfSolarControlSetPointsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfSolarControlSetPoints.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfSolarControlSetPoints();
    }
    ...
    public Class get_type() {
        return SequenceOfSolarControlSetPoints.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfSolarControlSetPoints</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfSolarControlSetPoints typedDst = (SequenceOfSolarControlSetPoints) destination;
        SequenceOfSolarControlSetPoints typedSrc = (SequenceOfSolarControlSetPoints) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.solarmodule.MaxLengthSolarControlSetPoints.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfSolarControlSetPoints typedSrc = (SequenceOfSolarControlSetPoints) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.solarmodule.MaxLengthSolarControlSetPoints.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfSolarControlSetPoints typedDst = (SequenceOfSolarControlSetPoints) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.solarmodule.MaxLengthSolarControlSetPoints.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfSolarControlSetPoints typedDst = (SequenceOfSolarControlSetPoints) sample;
    ...
    protected SequenceOfSolarControlSetPointsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfSolarControlSetPointsTypeCode.VALUE,SequenceOfSolarControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfSolarControlSetPointsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfSolarControlSetPointsTypeCode.VALUE,SequenceOfSolarControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
