...
public class BatteryReadingModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::BatteryReadingModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatteryReadingModuleTypeSupport _singleton
    = new BatteryReadingModuleTypeSupport();
    ...
    */
    public static BatteryReadingModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static BatteryReadingModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatteryReadingModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return BatteryReadingModule.create();
    }
    ...
    public Object create_key() {
        return new BatteryReadingModule();
    }
    ...
    public Class get_type() {
        return BatteryReadingModule.class;
    }
    ...
    * <code>this</code> is not a <code>BatteryReadingModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatteryReadingModule typedDst = (BatteryReadingModule) destination;
        BatteryReadingModule typedSrc = (BatteryReadingModule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.SequenceOfBatteryReadingsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.SequenceOfBatteryReadingsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatteryReadingModule typedSrc = (BatteryReadingModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.batterymodule.SequenceOfBatteryReadingsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.batterymodule.SequenceOfBatteryReadingsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.readings, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            BatteryReadingModule typedDst = (BatteryReadingModule) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.readings = (org.openfmb.model.dds.rti.openfmb.batterymodule.SequenceOfBatteryReadings)org.openfmb.model.dds.rti.openfmb.batterymodule.SequenceOfBatteryReadingsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.readings, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.batterymodule.SequenceOfBatteryReadingsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatteryReadingModule typedDst = (BatteryReadingModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        BatteryReadingModule typedDst
        = (BatteryReadingModule) instance;
        BatteryReadingModule typedSrc
        = (BatteryReadingModule) key;
    ...
    */
    ...
    int mask) {
        return new BatteryReadingModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new BatteryReadingModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected BatteryReadingModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,BatteryReadingModuleTypeCode.VALUE,BatteryReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatteryReadingModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatteryReadingModuleTypeCode.VALUE,BatteryReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
