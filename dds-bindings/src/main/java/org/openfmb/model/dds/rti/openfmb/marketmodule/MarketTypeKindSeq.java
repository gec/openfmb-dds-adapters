...
/**
* A sequence of MarketTypeKind instances.
*/
public final class MarketTypeKindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MarketTypeKindSeq() {
        super(MarketTypeKind.class);
    }

    public MarketTypeKindSeq (int initialMaximum) {
        super(MarketTypeKind.class, initialMaximum);
    }

    public MarketTypeKindSeq (Collection elements) {
        super(MarketTypeKind.class, elements);
    }
