...
/**
* A sequence of WeatherData instances.
*/
public final class WeatherDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WeatherDataSeq() {
        super(WeatherData.class);
    }

    public WeatherDataSeq (int initialMaximum) {
        super(WeatherData.class, initialMaximum);
    }

    public WeatherDataSeq (Collection elements) {
        super(WeatherData.class, elements);
    }
