...
/**
* A sequence of BatterySystem instances.
*/
public final class BatterySystemSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public BatterySystemSeq() {
        super(BatterySystem.class);
    }

    public BatterySystemSeq (int initialMaximum) {
        super(BatterySystem.class, initialMaximum);
    }

    public BatterySystemSeq (Collection elements) {
        super(BatterySystem.class, elements);
    }
