...
* SequenceOfLoadMeasurements
*/

public class SequenceOfLoadMeasurementsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::SequenceOfLoadMeasurements";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfLoadMeasurementsTypeSupport _singleton
    = new SequenceOfLoadMeasurementsTypeSupport();
    ...
    */
    public static SequenceOfLoadMeasurementsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfLoadMeasurementsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfLoadMeasurementsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfLoadMeasurements.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfLoadMeasurements();
    }
    ...
    public Class get_type() {
        return SequenceOfLoadMeasurements.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfLoadMeasurements</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfLoadMeasurements typedDst = (SequenceOfLoadMeasurements) destination;
        SequenceOfLoadMeasurements typedSrc = (SequenceOfLoadMeasurements) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadMeasurements.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfLoadMeasurements typedSrc = (SequenceOfLoadMeasurements) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadMeasurements.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfLoadMeasurements typedDst = (SequenceOfLoadMeasurements) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.loadmodule.MaxLengthLoadMeasurements.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfLoadMeasurements typedDst = (SequenceOfLoadMeasurements) sample;
    ...
    protected SequenceOfLoadMeasurementsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfLoadMeasurementsTypeCode.VALUE,SequenceOfLoadMeasurements.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfLoadMeasurementsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfLoadMeasurementsTypeCode.VALUE,SequenceOfLoadMeasurements.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
