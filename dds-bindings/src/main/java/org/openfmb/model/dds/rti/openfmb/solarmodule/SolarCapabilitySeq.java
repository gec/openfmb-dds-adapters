...
/**
* A sequence of SolarCapability instances.
*/
public final class SolarCapabilitySeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SolarCapabilitySeq() {
        super(SolarCapability.class);
    }

    public SolarCapabilitySeq (int initialMaximum) {
        super(SolarCapability.class, initialMaximum);
    }

    public SolarCapabilitySeq (Collection elements) {
        super(SolarCapability.class, elements);
    }
