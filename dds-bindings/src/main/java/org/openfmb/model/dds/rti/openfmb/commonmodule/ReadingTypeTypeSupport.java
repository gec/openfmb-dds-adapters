...
public class ReadingTypeTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::ReadingType";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ReadingTypeTypeSupport _singleton
    = new ReadingTypeTypeSupport();
    ...
    */
    public static ReadingTypeTypeSupport get_instance() {
        return _singleton;
    }

    public static ReadingTypeTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ReadingTypeTypeCode.VALUE;
    }

    public Object create_data() {
        return ReadingType.create();
    }
    ...
    * <code>this</code> is not a <code>ReadingType</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ReadingType typedDst = (ReadingType) destination;
        ReadingType typedSrc = (ReadingType) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.flowdirection.FlowDirectionKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.flowdirection.FlowDirectionKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ReadingType typedSrc = (ReadingType) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.flowdirection.FlowDirectionKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.flowDirection);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.flowdirection.FlowDirectionKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.flowDirection, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            ReadingType typedDst = (ReadingType) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.flowDirection = (org.openfmb.model.dds.rti.openfmb.commonmodule.flowdirection.FlowDirectionKind)org.openfmb.model.dds.rti.openfmb.commonmodule.flowdirection.FlowDirectionKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.flowDirection, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.flowdirection.FlowDirectionKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            ReadingType typedDst = (ReadingType) sample;
    ...
    protected ReadingTypeTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,ReadingTypeTypeCode.VALUE,ReadingType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ReadingTypeTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ReadingTypeTypeCode.VALUE,ReadingType.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
