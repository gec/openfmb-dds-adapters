...
/**
* A sequence of ActivePower instances.
*/
public final class ActivePowerSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ActivePowerSeq() {
        super(ActivePower.class);
    }

    public ActivePowerSeq (int initialMaximum) {
        super(ActivePower.class, initialMaximum);
    }

    public ActivePowerSeq (Collection elements) {
        super(ActivePower.class, elements);
    }
