...
public class  LoadReadingProfileTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("readings", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadReadingsTypeCode.VALUE,3 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("openfmb::loadmodule::LoadReadingProfile",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
