...
public class PowerSystemResourceTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::PowerSystemResource";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final PowerSystemResourceTypeSupport _singleton
    = new PowerSystemResourceTypeSupport();
    ...
    */
    public static PowerSystemResourceTypeSupport get_instance() {
        return _singleton;
    }

    public static PowerSystemResourceTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return PowerSystemResourceTypeCode.VALUE;
    }

    public Object create_data() {
        return PowerSystemResource.create();
    }
    ...
    public Class get_type() {
        return PowerSystemResource.class;
    }
    ...
    * <code>this</code> is not a <code>PowerSystemResource</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        PowerSystemResource typedDst = (PowerSystemResource) destination;
        PowerSystemResource typedSrc = (PowerSystemResource) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        PowerSystemResource typedSrc = (PowerSystemResource) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            PowerSystemResource typedDst = (PowerSystemResource) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            PowerSystemResource typedDst = (PowerSystemResource) sample;
    ...
    protected PowerSystemResourceTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,PowerSystemResourceTypeCode.VALUE,PowerSystemResource.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected PowerSystemResourceTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,PowerSystemResourceTypeCode.VALUE,PowerSystemResource.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
