...
public class PhaseCodeKind  extends Enum {
    ...
    public static final PhaseCodeKind noPhase = new PhaseCodeKind("noPhase", 15);
    public static final int _noPhase = 15;
    ...
    public static PhaseCodeKind valueOf(int ordinal) {
        switch(ordinal) {
            ...
            case 15: return PhaseCodeKind.noPhase;
