...
/**
* A sequence of EnergyConsumer instances.
*/
public final class EnergyConsumerSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public EnergyConsumerSeq() {
        super(EnergyConsumer.class);
    }

    public EnergyConsumerSeq (int initialMaximum) {
        super(EnergyConsumer.class, initialMaximum);
    }

    public EnergyConsumerSeq (Collection elements) {
        super(EnergyConsumer.class, elements);
    }
