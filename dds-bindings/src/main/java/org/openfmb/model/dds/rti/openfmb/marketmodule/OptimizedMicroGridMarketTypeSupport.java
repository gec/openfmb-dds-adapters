...
public class OptimizedMicroGridMarketTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::OptimizedMicroGridMarket";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final OptimizedMicroGridMarketTypeSupport _singleton
    = new OptimizedMicroGridMarketTypeSupport();
    ...
    */
    public static OptimizedMicroGridMarketTypeSupport get_instance() {
        return _singleton;
    }

    public static OptimizedMicroGridMarketTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return OptimizedMicroGridMarketTypeCode.VALUE;
    }

    public Object create_data() {
        return OptimizedMicroGridMarket.create();
    }
    ...
    public Class get_type() {
        return OptimizedMicroGridMarket.class;
    }
    ...
    * <code>this</code> is not a <code>OptimizedMicroGridMarket</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        OptimizedMicroGridMarket typedDst = (OptimizedMicroGridMarket) destination;
        OptimizedMicroGridMarket typedSrc = (OptimizedMicroGridMarket) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((255))+1);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketFactorsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketFactorsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        OptimizedMicroGridMarket typedSrc = (OptimizedMicroGridMarket) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.BOOLEAN.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.localTimeZone );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.name );
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.status );
        currentAlignment  +=  CdrPrimitiveType.FLOAT.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.tradingPeriod );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketFactorsTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.marketFactors);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.marketRuns);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.actualEnd);

            dst.writeLong(typedSrc.actualStart);

            dst.writeString(typedSrc.description,(255));

            dst.writeBoolean(typedSrc.dst);

            dst.writeLong(typedSrc.end);

            dst.writeString(typedSrc.localTimeZone,(255));

            dst.writeString(typedSrc.name,(255));

            dst.writeLong(typedSrc.start);

            dst.writeString(typedSrc.status,(255));

            dst.writeFloat(typedSrc.timeIntervalLength);

            dst.writeLong(typedSrc.tradingDay);

            dst.writeString(typedSrc.tradingPeriod,(255));

            org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketFactorsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.marketFactors, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.marketRuns, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            OptimizedMicroGridMarket typedDst = (OptimizedMicroGridMarket) dst;
            typedDst.clear();      
            try{
                typedDst.mRID = src.readString((255));
                typedDst.actualEnd = src.readLong();
                typedDst.actualStart = src.readLong();
                typedDst.description = src.readString((255));
                typedDst.dst = src.readBoolean();
                typedDst.end = src.readLong();
                typedDst.localTimeZone = src.readString((255));
                typedDst.name = src.readString((255));
                typedDst.start = src.readLong();
                typedDst.status = src.readString((255));
                typedDst.timeIntervalLength = src.readFloat();
                typedDst.tradingDay = src.readLong();
                typedDst.tradingPeriod = src.readString((255));
                typedDst.marketFactors = (org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketFactors)org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketFactorsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marketFactors, src, false, true, endpoint_plugin_qos);     
                typedDst.marketRuns = (org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketRuns)org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marketRuns, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketFactorsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfOptimizedMicroGridMarketMarketRunsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            OptimizedMicroGridMarket typedDst = (OptimizedMicroGridMarket) sample;
    ...
    protected OptimizedMicroGridMarketTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,OptimizedMicroGridMarketTypeCode.VALUE,OptimizedMicroGridMarket.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected OptimizedMicroGridMarketTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,OptimizedMicroGridMarketTypeCode.VALUE,OptimizedMicroGridMarket.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
