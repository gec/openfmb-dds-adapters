...
public class BatterySystemControlTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::batterymodule::BatterySystemControl";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final BatterySystemControlTypeSupport _singleton
    = new BatterySystemControlTypeSupport();
    ...
    */
    public static BatterySystemControlTypeSupport get_instance() {
        return _singleton;
    }

    public static BatterySystemControlTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return BatterySystemControlTypeCode.VALUE;
    }

    public Object create_data() {
        return BatterySystemControl.create();
    }
    ...
    public Class get_type() {
        return BatterySystemControl.class;
    }
    ...
    * <code>this</code> is not a <code>BatterySystemControl</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        BatterySystemControl typedDst = (BatterySystemControl) destination;
        BatterySystemControl typedSrc = (BatterySystemControl) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        BatterySystemControl typedSrc = (BatterySystemControl) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            BatterySystemControl typedDst = (BatterySystemControl) sample;
    ...
    protected BatterySystemControlTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,BatterySystemControlTypeCode.VALUE,BatterySystemControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected BatterySystemControlTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,BatterySystemControlTypeCode.VALUE,BatterySystemControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
