...
* SequenceOfEndDeviceControlSetPoints
*/

public class SequenceOfEndDeviceControlSetPointsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::SequenceOfEndDeviceControlSetPoints";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfEndDeviceControlSetPointsTypeSupport _singleton
    = new SequenceOfEndDeviceControlSetPointsTypeSupport();
    ...
    */
    public static SequenceOfEndDeviceControlSetPointsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfEndDeviceControlSetPointsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfEndDeviceControlSetPointsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfEndDeviceControlSetPoints.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfEndDeviceControlSetPoints();
    }
    ...
    public Class get_type() {
        return SequenceOfEndDeviceControlSetPoints.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfEndDeviceControlSetPoints</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfEndDeviceControlSetPoints typedDst = (SequenceOfEndDeviceControlSetPoints) destination;
        SequenceOfEndDeviceControlSetPoints typedSrc = (SequenceOfEndDeviceControlSetPoints) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthEndDeviceControlSetPoints.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfEndDeviceControlSetPoints typedSrc = (SequenceOfEndDeviceControlSetPoints) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthEndDeviceControlSetPoints.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfEndDeviceControlSetPoints typedDst = (SequenceOfEndDeviceControlSetPoints) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.SetPointTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthEndDeviceControlSetPoints.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfEndDeviceControlSetPoints typedDst = (SequenceOfEndDeviceControlSetPoints) sample;
    ...
    protected SequenceOfEndDeviceControlSetPointsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfEndDeviceControlSetPointsTypeCode.VALUE,SequenceOfEndDeviceControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfEndDeviceControlSetPointsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfEndDeviceControlSetPointsTypeCode.VALUE,SequenceOfEndDeviceControlSetPoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
