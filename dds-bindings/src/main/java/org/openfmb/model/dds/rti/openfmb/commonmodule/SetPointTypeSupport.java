...
public class SetPointTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::SetPoint";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SetPointTypeSupport _singleton
    = new SetPointTypeSupport();
    ...
    */
    public static SetPointTypeSupport get_instance() {
        return _singleton;
    }

    public static SetPointTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SetPointTypeCode.VALUE;
    }

    public Object create_data() {
        return SetPoint.create();
    }
    ...
    * <code>this</code> is not a <code>SetPoint</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SetPoint typedDst = (SetPoint) destination;
        SetPoint typedSrc = (SetPoint) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SetPoint typedSrc = (SetPoint) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.controlType );
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeString(typedSrc.controlType,(255));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SetPoint typedDst = (SetPoint) dst;
            typedDst.clear();      
            try{
                typedDst.controlType = src.readString((255));
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SetPoint typedDst = (SetPoint) sample;
    ...
    protected SetPointTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SetPointTypeCode.VALUE,SetPoint.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SetPointTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SetPointTypeCode.VALUE,SetPoint.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
