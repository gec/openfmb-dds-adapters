...
public class FlowDirectionKindTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::flowdirection::FlowDirectionKind";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final FlowDirectionKindTypeSupport _singleton
    = new FlowDirectionKindTypeSupport();
    ...
    */
    public static FlowDirectionKindTypeSupport get_instance() {
        return _singleton;
    }

    public static FlowDirectionKindTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return FlowDirectionKindTypeCode.VALUE;
    }
    ...
    public Class get_type() {
        return FlowDirectionKind.class;
    }
    ...
    * <code>this</code> is not a <code>FlowDirectionKind</code>
    * type.
    */
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        FlowDirectionKind typedSrc = (FlowDirectionKind) src;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            dst = FlowDirectionKind.valueOf(ordinal);
            if (dst == null) {
    ...
    protected FlowDirectionKindTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,FlowDirectionKindTypeCode.VALUE,FlowDirectionKind.class,TypeSupportType.TST_ENUM, PLUGIN_VERSION);
