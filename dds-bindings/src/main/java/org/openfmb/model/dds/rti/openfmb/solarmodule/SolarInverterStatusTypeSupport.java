...
public class SolarInverterStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarInverterStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarInverterStatusTypeSupport _singleton
    = new SolarInverterStatusTypeSupport();
    ...
    */
    public static SolarInverterStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarInverterStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarInverterStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarInverterStatus.create();
    }
    ...
    public Class get_type() {
        return SolarInverterStatus.class;
    }
    ...
    * <code>this</code> is not a <code>SolarInverterStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarInverterStatus typedDst = (SolarInverterStatus) destination;
        SolarInverterStatus typedSrc = (SolarInverterStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarInverterStatus typedSrc = (SolarInverterStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarInverterStatus typedDst = (SolarInverterStatus) sample;
    ...
    protected SolarInverterStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarInverterStatusTypeCode.VALUE,SolarInverterStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarInverterStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarInverterStatusTypeCode.VALUE,SolarInverterStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
