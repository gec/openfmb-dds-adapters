...
public class HumidityTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::Humidity";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final HumidityTypeSupport _singleton
    = new HumidityTypeSupport();
    ...
    */
    public static HumidityTypeSupport get_instance() {
        return _singleton;
    }

    public static HumidityTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return HumidityTypeCode.VALUE;
    }

    public Object create_data() {
        return Humidity.create();
    }
    ...
    * <code>this</code> is not a <code>Humidity</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Humidity typedDst = (Humidity) destination;
        Humidity typedSrc = (Humidity) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.SequenceOfHumidityDataTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.SequenceOfHumidityDataTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        Humidity typedSrc = (Humidity) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.SequenceOfHumidityDataTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.humidityData);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.SequenceOfHumidityDataTypeSupport.get_instance().serialize(endpoint_data, typedSrc.humidityData, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            Humidity typedDst = (Humidity) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.humidityData = (org.openfmb.model.dds.rti.openfmb.weathermodule.SequenceOfHumidityData)org.openfmb.model.dds.rti.openfmb.weathermodule.SequenceOfHumidityDataTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.humidityData, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.SequenceOfHumidityDataTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            Humidity typedDst = (Humidity) sample;
    ...
    protected HumidityTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,HumidityTypeCode.VALUE,Humidity.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected HumidityTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,HumidityTypeCode.VALUE,Humidity.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
