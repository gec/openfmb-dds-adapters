...
public class SolarControlTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarControl";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarControlTypeSupport _singleton
    = new SolarControlTypeSupport();
    ...
    */
    public static SolarControlTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarControlTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarControlTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarControl.create();
    }
    ...
    * <code>this</code> is not a <code>SolarControl</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarControl typedDst = (SolarControl) destination;
        SolarControl typedSrc = (SolarControl) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarControlSetPointsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarControlSetPointsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarControl typedSrc = (SolarControl) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarControlSetPointsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarControlSetPointsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.setPoints, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarControl typedDst = (SolarControl) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.setPoints = (org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarControlSetPoints)org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarControlSetPointsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.setPoints, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.solarmodule.SequenceOfSolarControlSetPointsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarControl typedDst = (SolarControl) sample;
    ...
    protected SolarControlTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SolarControlTypeCode.VALUE,SolarControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarControlTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarControlTypeCode.VALUE,SolarControl.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
