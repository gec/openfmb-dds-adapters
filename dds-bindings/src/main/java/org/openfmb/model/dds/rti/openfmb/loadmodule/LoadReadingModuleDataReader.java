...
/**
* A reader for the LoadReadingModule user type.
*/
public class LoadReadingModuleDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(LoadReadingModuleSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    ...
    public void take(LoadReadingModuleSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(LoadReadingModuleSeq received_data, 
    ...
    public void take_w_condition(LoadReadingModuleSeq received_data, 
    SampleInfoSeq info_seq,
    int max_samples,
    ReadCondition condition) {
    ...
    public void read_next_sample(LoadReadingModule received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }

    public void take_next_sample(LoadReadingModule received_data, SampleInfo sample_info) {
        take_next_sample_untyped(received_data, sample_info);
    }

    public void read_instance(LoadReadingModuleSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(LoadReadingModuleSeq received_data, SampleInfoSeq info_seq,
    int max_samples, InstanceHandle_t a_handle, int sample_states,
    int view_states, int instance_states) {
    ...
    public void read_instance_w_condition(LoadReadingModuleSeq received_data,
    ...
    public void take_instance_w_condition(LoadReadingModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void read_next_instance(LoadReadingModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance(LoadReadingModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, int sample_states, int view_states,
    int instance_states) {
    ...
    public void read_next_instance_w_condition(LoadReadingModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void take_next_instance_w_condition(LoadReadingModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(LoadReadingModuleSeq received_data, SampleInfoSeq info_seq) {
        return_loan_untyped(received_data, info_seq);
    }

    public void get_key_value(LoadReadingModule key_holder, InstanceHandle_t handle){
        get_key_value_untyped(key_holder, handle);
    }

    public InstanceHandle_t lookup_instance(LoadReadingModule key_holder) {
    ...
    /*package*/  LoadReadingModuleDataReader (long native_reader, DataReaderListener listener,
