...
public class ResourceReadingProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::resourcemodule::ResourceReadingProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final ResourceReadingProfileTypeSupport _singleton
    = new ResourceReadingProfileTypeSupport();
    ...
    */
    public static ResourceReadingProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static ResourceReadingProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return ResourceReadingProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return ResourceReadingProfile.create();
    }
    ...
    public Class get_type() {
        return ResourceReadingProfile.class;
    }
    ...
    * <code>this</code> is not a <code>ResourceReadingProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        ResourceReadingProfile typedDst = (ResourceReadingProfile) destination;
        ResourceReadingProfile typedSrc = (ResourceReadingProfile) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        ResourceReadingProfile typedSrc = (ResourceReadingProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    */
    ...
    Object instance,
    Object key) {
        ResourceReadingProfile typedDst
    ...
    */
    ...
    int mask) {
        return new ResourceReadingProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new ResourceReadingProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected ResourceReadingProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,ResourceReadingProfileTypeCode.VALUE,ResourceReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected ResourceReadingProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,ResourceReadingProfileTypeCode.VALUE,ResourceReadingProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
