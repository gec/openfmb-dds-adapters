...
/**
* A sequence of Wind instances.
*/
public final class WindSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public WindSeq (int initialMaximum) {
        super(Wind.class, initialMaximum);
    }

    public WindSeq (Collection elements) {
        super(Wind.class, elements);
    }
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' Wind objects (beyond the original size of this object)
