...
public class MarketFactorsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::interchangemodule::MarketFactors";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarketFactorsTypeSupport _singleton
    = new MarketFactorsTypeSupport();
    ...
    */
    public static MarketFactorsTypeSupport get_instance() {
        return _singleton;
    }

    public static MarketFactorsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarketFactorsTypeCode.VALUE;
    }

    public Object create_data() {
        return MarketFactors.create();
    }
    ...
    * <code>this</code> is not a <code>MarketFactors</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MarketFactors typedDst = (MarketFactors) destination;
        MarketFactors typedSrc = (MarketFactors) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MarketFactors typedSrc = (MarketFactors) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeLong(typedSrc.intervalEndTime);

            dst.writeLong(typedSrc.intervalStartTime);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MarketFactors typedDst = (MarketFactors) dst;
            typedDst.clear();      
            try{
                typedDst.intervalEndTime = src.readLong();
                typedDst.intervalStartTime = src.readLong();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MarketFactors typedDst = (MarketFactors) sample;
    ...
    protected MarketFactorsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarketFactorsTypeCode.VALUE,MarketFactors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MarketFactorsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MarketFactorsTypeCode.VALUE,MarketFactors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
