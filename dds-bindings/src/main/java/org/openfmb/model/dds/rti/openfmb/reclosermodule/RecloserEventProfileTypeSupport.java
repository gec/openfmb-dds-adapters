...
public class RecloserEventProfileTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::RecloserEventProfile";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final RecloserEventProfileTypeSupport _singleton
    = new RecloserEventProfileTypeSupport();
    ...
    */
    public static RecloserEventProfileTypeSupport get_instance() {
        return _singleton;
    }

    public static RecloserEventProfileTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return RecloserEventProfileTypeCode.VALUE;
    }

    public Object create_data() {
        return RecloserEventProfile.create();
    }
    ...
    public Class get_type() {
        return RecloserEventProfile.class;
    }
    ...
    * <code>this</code> is not a <code>RecloserEventProfile</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        RecloserEventProfile typedDst = (RecloserEventProfile) destination;
        RecloserEventProfile typedSrc = (RecloserEventProfile) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserStatusTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserStatusTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        RecloserEventProfile typedSrc = (RecloserEventProfile) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserStatusTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.recloserStatus);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserStatusTypeSupport.get_instance().serialize(endpoint_data, typedSrc.recloserStatus, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            RecloserEventProfile typedDst = (RecloserEventProfile) dst;
            typedDst.clear();      
            ...
            try{
                ...
                typedDst.recloserStatus = (org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserStatus)org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserStatusTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.recloserStatus, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserStatusTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            RecloserEventProfile typedDst = (RecloserEventProfile) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        RecloserEventProfile typedDst
        = (RecloserEventProfile) instance;
        RecloserEventProfile typedSrc
        = (RecloserEventProfile) key;
    ...
    */
    ...
    int mask) {
        return new RecloserEventProfileDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new RecloserEventProfileDataReader(native_reader, listener, mask, this);   
    ...
    protected RecloserEventProfileTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,RecloserEventProfileTypeCode.VALUE,RecloserEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected RecloserEventProfileTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,RecloserEventProfileTypeCode.VALUE,RecloserEventProfile.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
