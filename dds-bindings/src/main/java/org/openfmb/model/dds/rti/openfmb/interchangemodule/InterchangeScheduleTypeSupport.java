...
public class InterchangeScheduleTypeSupport extends TypeSupportImpl {
    ...
    private static final String TYPE_NAME = "openfmb::interchangemodule::InterchangeSchedule";
    ...
    */
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.MarketProductTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.EnergyProductTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.OptimizedMicroGridMarketTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.MarketProductTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.EnergyProductTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.OptimizedMicroGridMarketTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.directionType);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.MarketProductTypeKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.energyType);
        currentAlignment  +=  CdrPrimitiveType.INT.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.EnergyProductTypeKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.scheduleType);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.interchangemodule.OptimizedMicroGridMarketTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.CurveTypeSupport.get_instance().serialize(endpoint_data,src,dst,false,encapsulation_id,serialize_sample,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.directionType, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.commonmodule.MarketProductTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.energyType, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeInt(typedSrc.intervalLength);

            org.openfmb.model.dds.rti.openfmb.commonmodule.EnergyProductTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.scheduleType, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.interchangemodule.OptimizedMicroGridMarketTypeSupport.get_instance().serialize(endpoint_data, typedSrc.optimizedMicroGridMarket, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            typedDst.clear();      
            org.openfmb.model.dds.rti.openfmb.commonmodule.CurveTypeSupport.get_instance().deserialize_sample(endpoint_data,dst,src,false,deserialize_sample,endpoint_plugin_qos);

            try{
                typedDst.directionType = (org.openfmb.model.dds.rti.openfmb.commonmodule.InterTieDirectionKind)org.openfmb.model.dds.rti.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.directionType, src, false, true, endpoint_plugin_qos);     
                typedDst.energyType = (org.openfmb.model.dds.rti.openfmb.commonmodule.MarketProductTypeKind)org.openfmb.model.dds.rti.openfmb.commonmodule.MarketProductTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.energyType, src, false, true, endpoint_plugin_qos);     
                typedDst.intervalLength = src.readInt();
                typedDst.scheduleType = (org.openfmb.model.dds.rti.openfmb.commonmodule.EnergyProductTypeKind)org.openfmb.model.dds.rti.openfmb.commonmodule.EnergyProductTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.scheduleType, src, false, true, endpoint_plugin_qos);     
                typedDst.optimizedMicroGridMarket = (org.openfmb.model.dds.rti.openfmb.interchangemodule.OptimizedMicroGridMarket)org.openfmb.model.dds.rti.openfmb.interchangemodule.OptimizedMicroGridMarketTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.optimizedMicroGridMarket, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.InterTieDirectionKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.commonmodule.MarketProductTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            src.skipInt();

            org.openfmb.model.dds.rti.openfmb.commonmodule.EnergyProductTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.interchangemodule.OptimizedMicroGridMarketTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
