...
* SequenceOfResourceStatusMeasurements
*/

public class SequenceOfResourceStatusMeasurementsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::resourcemodule::SequenceOfResourceStatusMeasurements";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfResourceStatusMeasurementsTypeSupport _singleton
    = new SequenceOfResourceStatusMeasurementsTypeSupport();
    ...
    */
    public static SequenceOfResourceStatusMeasurementsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfResourceStatusMeasurementsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfResourceStatusMeasurementsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfResourceStatusMeasurements.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfResourceStatusMeasurements();
    }
    ...
    public Class get_type() {
        return SequenceOfResourceStatusMeasurements.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfResourceStatusMeasurements</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfResourceStatusMeasurements typedDst = (SequenceOfResourceStatusMeasurements) destination;
        SequenceOfResourceStatusMeasurements typedSrc = (SequenceOfResourceStatusMeasurements) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.resourcemodule.MaxLengthResourceStatusMeasurements.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfResourceStatusMeasurements typedSrc = (SequenceOfResourceStatusMeasurements) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.resourcemodule.MaxLengthResourceStatusMeasurements.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfResourceStatusMeasurements typedDst = (SequenceOfResourceStatusMeasurements) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.resourcemodule.MaxLengthResourceStatusMeasurements.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.StringMeasurementTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfResourceStatusMeasurements typedDst = (SequenceOfResourceStatusMeasurements) sample;
    ...
    protected SequenceOfResourceStatusMeasurementsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfResourceStatusMeasurementsTypeCode.VALUE,SequenceOfResourceStatusMeasurements.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfResourceStatusMeasurementsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfResourceStatusMeasurementsTypeCode.VALUE,SequenceOfResourceStatusMeasurements.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
