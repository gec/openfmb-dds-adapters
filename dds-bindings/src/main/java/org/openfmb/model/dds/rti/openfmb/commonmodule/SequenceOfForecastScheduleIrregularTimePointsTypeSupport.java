...
* SequenceOfForecastScheduleIrregularTimePoints
*/

public class SequenceOfForecastScheduleIrregularTimePointsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::commonmodule::SequenceOfForecastScheduleIrregularTimePoints";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfForecastScheduleIrregularTimePointsTypeSupport _singleton
    = new SequenceOfForecastScheduleIrregularTimePointsTypeSupport();
    ...
    */
    public static SequenceOfForecastScheduleIrregularTimePointsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfForecastScheduleIrregularTimePointsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfForecastScheduleIrregularTimePointsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfForecastScheduleIrregularTimePoints.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfForecastScheduleIrregularTimePoints();
    }
    ...
    public Class get_type() {
        return SequenceOfForecastScheduleIrregularTimePoints.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfForecastScheduleIrregularTimePoints</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfForecastScheduleIrregularTimePoints typedDst = (SequenceOfForecastScheduleIrregularTimePoints) destination;
        SequenceOfForecastScheduleIrregularTimePoints typedSrc = (SequenceOfForecastScheduleIrregularTimePoints) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthForecastScheduleIrregularTimePoints.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfForecastScheduleIrregularTimePoints typedSrc = (SequenceOfForecastScheduleIrregularTimePoints) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthForecastScheduleIrregularTimePoints.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfForecastScheduleIrregularTimePoints typedDst = (SequenceOfForecastScheduleIrregularTimePoints) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.commonmodule.MaxLengthForecastScheduleIrregularTimePoints.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.IrregularTimePointTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfForecastScheduleIrregularTimePoints typedDst = (SequenceOfForecastScheduleIrregularTimePoints) sample;
    ...
    protected SequenceOfForecastScheduleIrregularTimePointsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfForecastScheduleIrregularTimePointsTypeCode.VALUE,SequenceOfForecastScheduleIrregularTimePoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfForecastScheduleIrregularTimePointsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfForecastScheduleIrregularTimePointsTypeCode.VALUE,SequenceOfForecastScheduleIrregularTimePoints.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
