...
public class SolarForecastModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::solarmodule::SolarForecastModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SolarForecastModuleTypeSupport _singleton
    = new SolarForecastModuleTypeSupport();
    ...
    */
    public static SolarForecastModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static SolarForecastModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SolarForecastModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return SolarForecastModule.create();
    }
    ...
    public Object create_key() {
        return new SolarForecastModule();
    }
    ...
    public Class get_type() {
        return SolarForecastModule.class;
    }
    ...
    * <code>this</code> is not a <code>SolarForecastModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SolarForecastModule typedDst = (SolarForecastModule) destination;
        SolarForecastModule typedSrc = (SolarForecastModule) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SolarForecastModule typedSrc = (SolarForecastModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SolarForecastModule typedDst = (SolarForecastModule) dst;
            typedDst.clear();      
            try{
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SolarForecastModule typedDst = (SolarForecastModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        SolarForecastModule typedDst
        = (SolarForecastModule) instance;
        SolarForecastModule typedSrc
        = (SolarForecastModule) key;
    ...
    */
    ...
    int mask) {
        return new SolarForecastModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new SolarForecastModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected SolarForecastModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,SolarForecastModuleTypeCode.VALUE,SolarForecastModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SolarForecastModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SolarForecastModuleTypeCode.VALUE,SolarForecastModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
