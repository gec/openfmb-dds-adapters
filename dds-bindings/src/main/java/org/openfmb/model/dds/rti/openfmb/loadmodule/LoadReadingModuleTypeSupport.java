...
public class LoadReadingModuleTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::loadmodule::LoadReadingModule";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final LoadReadingModuleTypeSupport _singleton
    = new LoadReadingModuleTypeSupport();
    ...
    */
    public static LoadReadingModuleTypeSupport get_instance() {
        return _singleton;
    }

    public static LoadReadingModuleTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return LoadReadingModuleTypeCode.VALUE;
    }

    public Object create_data() {
        return LoadReadingModule.create();
    }
    ...
    public Class get_type() {
        return LoadReadingModule.class;
    }
    ...
    * <code>this</code> is not a <code>LoadReadingModule</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        LoadReadingModule typedDst = (LoadReadingModule) destination;
        LoadReadingModule typedSrc = (LoadReadingModule) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadControlReadingsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadControlReadingsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        LoadReadingModule typedSrc = (LoadReadingModule) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadControlReadingsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadControlReadingsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.readings, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            LoadReadingModule typedDst = (LoadReadingModule) dst;
            typedDst.clear();      
            try{
                ...
                typedDst.readings = (org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadControlReadings)org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadControlReadingsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.readings, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.loadmodule.SequenceOfLoadControlReadingsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            LoadReadingModule typedDst = (LoadReadingModule) sample;
    ...
    */
    ...
    Object instance,
    Object key) {
        LoadReadingModule typedDst
        = (LoadReadingModule) instance;
        LoadReadingModule typedSrc
        = (LoadReadingModule) key;
    ...
    */
    ...
    int mask) {
        return new LoadReadingModuleDataWriter (native_writer, listener, mask, this);            
    }
    ...
    int mask) {
        ...
        return new LoadReadingModuleDataReader(native_reader, listener, mask, this);   
    ...
    protected LoadReadingModuleTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME,true,LoadReadingModuleTypeCode.VALUE,LoadReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected LoadReadingModuleTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,LoadReadingModuleTypeCode.VALUE,LoadReadingModule.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
