...
* SequenceOfMarketMarketRuns
*/

public class SequenceOfMarketMarketRunsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::SequenceOfMarketMarketRuns";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfMarketMarketRunsTypeSupport _singleton
    = new SequenceOfMarketMarketRunsTypeSupport();
    ...
    */
    public static SequenceOfMarketMarketRunsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfMarketMarketRunsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfMarketMarketRunsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfMarketMarketRuns.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfMarketMarketRuns();
    }
    ...
    public Class get_type() {
        return SequenceOfMarketMarketRuns.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfMarketMarketRuns</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfMarketMarketRuns typedDst = (SequenceOfMarketMarketRuns) destination;
        SequenceOfMarketMarketRuns typedSrc = (SequenceOfMarketMarketRuns) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.MarketRunTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.marketmodule.MaxLengthMarketMarketRuns.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfMarketMarketRuns typedSrc = (SequenceOfMarketMarketRuns) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.MarketRunTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.marketmodule.MaxLengthMarketMarketRuns.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfMarketMarketRuns typedDst = (SequenceOfMarketMarketRuns) dst;
            org.openfmb.model.dds.rti.openfmb.marketmodule.MarketRunTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.marketmodule.MaxLengthMarketMarketRuns.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfMarketMarketRuns typedDst = (SequenceOfMarketMarketRuns) sample;
    ...
    protected SequenceOfMarketMarketRunsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfMarketMarketRunsTypeCode.VALUE,SequenceOfMarketMarketRuns.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfMarketMarketRunsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfMarketMarketRunsTypeCode.VALUE,SequenceOfMarketMarketRuns.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
