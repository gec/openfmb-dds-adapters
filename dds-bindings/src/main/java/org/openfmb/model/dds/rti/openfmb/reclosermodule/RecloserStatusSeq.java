...
/**
* A sequence of RecloserStatus instances.
*/
public final class RecloserStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public RecloserStatusSeq() {
        super(RecloserStatus.class);
    }

    public RecloserStatusSeq (int initialMaximum) {
        super(RecloserStatus.class, initialMaximum);
    }

    public RecloserStatusSeq (Collection elements) {
        super(RecloserStatus.class, elements);
    }
