...
public class MarketTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::Market";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarketTypeSupport _singleton
    = new MarketTypeSupport();
    ...
    */
    public static MarketTypeSupport get_instance() {
        return _singleton;
    }

    public static MarketTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarketTypeCode.VALUE;
    }
    ...
    * <code>this</code> is not a <code>Market</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        Market typedDst = (Market) destination;
        Market typedSrc = (Market) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((255))+1);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketFactorsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketRunsTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketFactorsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketRunsTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        Object sample) 
    {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketFactorsTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.marketFactors);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketRunsTypeSupport.get_instance().get_serialized_sample_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketFactorsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.marketFactors, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketRunsTypeSupport.get_instance().serialize(endpoint_data, typedSrc.marketRuns, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            try{
                ...
                typedDst.marketFactors = (org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketFactors)org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketFactorsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marketFactors, src, false, true, endpoint_plugin_qos);     
                typedDst.marketRuns = (org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketRuns)org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketRunsTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marketRuns, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketFactorsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);

            org.openfmb.model.dds.rti.openfmb.marketmodule.SequenceOfMarketMarketRunsTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
    ...
    protected MarketTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarketTypeCode.VALUE,Market.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MarketTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MarketTypeCode.VALUE,Market.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
