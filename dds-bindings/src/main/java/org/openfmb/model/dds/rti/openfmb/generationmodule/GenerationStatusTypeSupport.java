...
public class GenerationStatusTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::generationmodule::GenerationStatus";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final GenerationStatusTypeSupport _singleton
    = new GenerationStatusTypeSupport();
    ...
    */
    public static GenerationStatusTypeSupport get_instance() {
        return _singleton;
    }

    public static GenerationStatusTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return GenerationStatusTypeCode.VALUE;
    }

    public Object create_data() {
        return GenerationStatus.create();
    }
    ...
    * <code>this</code> is not a <code>GenerationStatus</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        GenerationStatus typedDst = (GenerationStatus) destination;
        GenerationStatus typedSrc = (GenerationStatus) source;
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        GenerationStatus typedSrc = (GenerationStatus) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            dst.writeBoolean(typedSrc.isAutoOn);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            GenerationStatus typedDst = (GenerationStatus) dst;
            typedDst.clear();      
            try{
                typedDst.isAutoOn = src.readBoolean();
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            GenerationStatus typedDst = (GenerationStatus) sample;
    ...
    protected GenerationStatusTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,GenerationStatusTypeCode.VALUE,GenerationStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected GenerationStatusTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,GenerationStatusTypeCode.VALUE,GenerationStatus.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
