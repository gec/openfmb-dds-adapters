...
* SequenceOfMarketMarketFactors
*/

public class SequenceOfMarketMarketFactorsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::marketmodule::SequenceOfMarketMarketFactors";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfMarketMarketFactorsTypeSupport _singleton
    = new SequenceOfMarketMarketFactorsTypeSupport();
    ...
    */
    public static SequenceOfMarketMarketFactorsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfMarketMarketFactorsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfMarketMarketFactorsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfMarketMarketFactors.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfMarketMarketFactors();
    }
    ...
    public Class get_type() {
        return SequenceOfMarketMarketFactors.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfMarketMarketFactors</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfMarketMarketFactors typedDst = (SequenceOfMarketMarketFactors) destination;
        SequenceOfMarketMarketFactors typedSrc = (SequenceOfMarketMarketFactors) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.marketmodule.MarketFactorsTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.marketmodule.MaxLengthMarketMarketFactors.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfMarketMarketFactors typedSrc = (SequenceOfMarketMarketFactors) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.marketmodule.MarketFactorsTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.marketmodule.MaxLengthMarketMarketFactors.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfMarketMarketFactors typedDst = (SequenceOfMarketMarketFactors) dst;
            org.openfmb.model.dds.rti.openfmb.marketmodule.MarketFactorsTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.marketmodule.MaxLengthMarketMarketFactors.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfMarketMarketFactors typedDst = (SequenceOfMarketMarketFactors) sample;
    ...
    protected SequenceOfMarketMarketFactorsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfMarketMarketFactorsTypeCode.VALUE,SequenceOfMarketMarketFactors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfMarketMarketFactorsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfMarketMarketFactorsTypeCode.VALUE,SequenceOfMarketMarketFactors.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
