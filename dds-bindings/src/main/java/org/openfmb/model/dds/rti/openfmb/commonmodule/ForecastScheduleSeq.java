...
/**
* A sequence of ForecastSchedule instances.
*/
public final class ForecastScheduleSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public ForecastScheduleSeq() {
        super(ForecastSchedule.class);
    }

    public ForecastScheduleSeq (int initialMaximum) {
        super(ForecastSchedule.class, initialMaximum);
    }

    public ForecastScheduleSeq (Collection elements) {
        super(ForecastSchedule.class, elements);
    }
