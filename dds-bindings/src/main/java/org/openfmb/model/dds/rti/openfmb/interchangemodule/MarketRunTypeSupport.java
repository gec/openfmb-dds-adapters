...
public class MarketRunTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::interchangemodule::MarketRun";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final MarketRunTypeSupport _singleton
    = new MarketRunTypeSupport();
    ...
    */
    public static MarketRunTypeSupport get_instance() {
        return _singleton;
    }

    public static MarketRunTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return MarketRunTypeCode.VALUE;
    }

    public Object create_data() {
        return MarketRun.create();
    }
    ...
    * <code>this</code> is not a <code>MarketRun</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        MarketRun typedDst = (MarketRun) destination;
        MarketRun typedSrc = (MarketRun) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ExecutionTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        ...
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, ((255))+1);
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.MarketTypeKindTypeSupport.get_instance().get_serialized_sample_max_size(endpoint_data,false, encapsulation_id,currentAlignment);
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ExecutionTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += CdrPrimitiveType.getStringMaxSizeSerialized(currentAlignment, 1);
        currentAlignment += CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment );
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.MarketTypeKindTypeSupport.get_instance().get_serialized_sample_min_size(endpoint_data,false, encapsulation_id,currentAlignment);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        MarketRun typedSrc = (MarketRun) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ExecutionTypeKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.executionType);
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.marketID );
        currentAlignment  +=  CdrPrimitiveType.getStringSerializedSize(currentAlignment , typedSrc.marketRunID );
        currentAlignment  +=  CdrPrimitiveType.LONG.getMaxSizeSerialized(currentAlignment);
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.MarketTypeKindTypeSupport.get_instance().get_serialized_sample_size(
            endpoint_data,false,encapsulation_id,currentAlignment,typedSrc.marketType);
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ExecutionTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.executionType, dst, false, encapsulation_id,true,endpoint_plugin_qos);

            dst.writeLong(typedSrc.marketEndTime);

            dst.writeString(typedSrc.marketID,(255));

            dst.writeString(typedSrc.marketRunID,(255));

            dst.writeLong(typedSrc.marketStartTime);

            org.openfmb.model.dds.rti.openfmb.commonmodule.MarketTypeKindTypeSupport.get_instance().serialize(endpoint_data, typedSrc.marketType, dst, false, encapsulation_id,true,endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            MarketRun typedDst = (MarketRun) dst;
            typedDst.clear();      
            try{
                typedDst.executionType = (org.openfmb.model.dds.rti.openfmb.commonmodule.ExecutionTypeKind)org.openfmb.model.dds.rti.openfmb.commonmodule.ExecutionTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.executionType, src, false, true, endpoint_plugin_qos);     
                typedDst.marketEndTime = src.readLong();
                typedDst.marketID = src.readString((255));
                typedDst.marketRunID = src.readString((255));
                typedDst.marketStartTime = src.readLong();
                typedDst.marketType = (org.openfmb.model.dds.rti.openfmb.commonmodule.MarketTypeKind)org.openfmb.model.dds.rti.openfmb.commonmodule.MarketTypeKindTypeSupport.get_instance().deserialize_sample(endpoint_data, typedDst.marketType, src, false, true, endpoint_plugin_qos);     
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ExecutionTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.MarketTypeKindTypeSupport.get_instance().skip(endpoint_data, src, false, true, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            MarketRun typedDst = (MarketRun) sample;
    ...
    protected MarketRunTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,MarketRunTypeCode.VALUE,MarketRun.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected MarketRunTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,MarketRunTypeCode.VALUE,MarketRun.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
