...
public class  MarketRunTypeCode {
    ...
    private static TypeCode getTypeCode() {
        ...
        sm[__i]=new  StructMember("executionType", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.openfmb.marketmodule.ExecutionTypeKindTypeCode.VALUE,0 , false);__i++;
        ...
        sm[__i]=new  StructMember("marketType", false, (short)-1,  false,(TypeCode) org.openfmb.model.dds.rti.openfmb.marketmodule.MarketTypeKindTypeCode.VALUE,5 , false);__i++;

        tc = TypeCodeFactory.TheTypeCodeFactory.create_struct_tc("openfmb::marketmodule::MarketRun",ExtensibilityKind.EXTENSIBLE_EXTENSIBILITY,  sm);        
        return tc;
    }
}
