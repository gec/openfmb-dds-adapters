...
/**
* A sequence of MarketFactors instances.
*/
public final class MarketFactorsSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public MarketFactorsSeq() {
        super(MarketFactors.class);
    }

    public MarketFactorsSeq (int initialMaximum) {
        super(MarketFactors.class, initialMaximum);
    }

    public MarketFactorsSeq (Collection elements) {
        super(MarketFactors.class, elements);
    }
