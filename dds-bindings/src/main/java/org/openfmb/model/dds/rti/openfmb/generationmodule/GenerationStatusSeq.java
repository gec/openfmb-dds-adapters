...
/**
* A sequence of GenerationStatus instances.
*/
public final class GenerationStatusSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public GenerationStatusSeq() {
        super(GenerationStatus.class);
    }

    public GenerationStatusSeq (int initialMaximum) {
        super(GenerationStatus.class, initialMaximum);
    }

    public GenerationStatusSeq (Collection elements) {
        super(GenerationStatus.class, elements);
    }
