...
* SequenceOfRecloserReadings
*/

public class SequenceOfRecloserReadingsTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::reclosermodule::SequenceOfRecloserReadings";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfRecloserReadingsTypeSupport _singleton
    = new SequenceOfRecloserReadingsTypeSupport();
    ...
    */
    public static SequenceOfRecloserReadingsTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfRecloserReadingsTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfRecloserReadingsTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfRecloserReadings.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfRecloserReadings();
    }
    ...
    public Class get_type() {
        return SequenceOfRecloserReadings.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfRecloserReadings</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfRecloserReadings typedDst = (SequenceOfRecloserReadings) destination;
        SequenceOfRecloserReadings typedSrc = (SequenceOfRecloserReadings) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.reclosermodule.MaxLengthRecloserReadings.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfRecloserReadings typedSrc = (SequenceOfRecloserReadings) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.reclosermodule.MaxLengthRecloserReadings.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfRecloserReadings typedDst = (SequenceOfRecloserReadings) dst;
            org.openfmb.model.dds.rti.openfmb.commonmodule.ReadingTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.reclosermodule.MaxLengthRecloserReadings.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfRecloserReadings typedDst = (SequenceOfRecloserReadings) sample;
    ...
    protected SequenceOfRecloserReadingsTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfRecloserReadingsTypeCode.VALUE,SequenceOfRecloserReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfRecloserReadingsTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfRecloserReadingsTypeCode.VALUE,SequenceOfRecloserReadings.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
