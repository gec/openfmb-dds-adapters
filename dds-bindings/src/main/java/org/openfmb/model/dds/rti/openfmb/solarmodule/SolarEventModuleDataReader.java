...
/**
* A reader for the SolarEventModule user type.
*/
public class SolarEventModuleDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(SolarEventModuleSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    ...
    public void take(SolarEventModuleSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(SolarEventModuleSeq received_data, 
    ...
    public void take_w_condition(SolarEventModuleSeq received_data, 
    SampleInfoSeq info_seq,
    int max_samples,
    ReadCondition condition) {
    ...
    public void read_next_sample(SolarEventModule received_data, SampleInfo sample_info) {
        read_next_sample_untyped(received_data, sample_info);
    }

    public void take_next_sample(SolarEventModule received_data, SampleInfo sample_info) {
        take_next_sample_untyped(received_data, sample_info);
    }

    public void read_instance(SolarEventModuleSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(SolarEventModuleSeq received_data, SampleInfoSeq info_seq,
    int max_samples, InstanceHandle_t a_handle, int sample_states,
    int view_states, int instance_states) {
    ...
    public void read_instance_w_condition(SolarEventModuleSeq received_data,
    ...
    public void take_instance_w_condition(SolarEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void read_next_instance(SolarEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance(SolarEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, int sample_states, int view_states,
    int instance_states) {
    ...
    public void read_next_instance_w_condition(SolarEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void take_next_instance_w_condition(SolarEventModuleSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(SolarEventModuleSeq received_data, SampleInfoSeq info_seq) {
    ...
    /*package*/  SolarEventModuleDataReader (long native_reader, DataReaderListener listener,
