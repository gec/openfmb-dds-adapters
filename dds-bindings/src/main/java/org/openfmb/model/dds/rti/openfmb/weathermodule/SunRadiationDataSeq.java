...
/**
* A sequence of SunRadiationData instances.
*/
public final class SunRadiationDataSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public SunRadiationDataSeq() {
        super(SunRadiationData.class);
    }

    public SunRadiationDataSeq (int initialMaximum) {
        super(SunRadiationData.class, initialMaximum);
    }

    public SunRadiationDataSeq (Collection elements) {
        super(SunRadiationData.class, elements);
    }
