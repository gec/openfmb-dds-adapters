...
* SequenceOfTemperatureData
*/

public class SequenceOfTemperatureDataTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "openfmb::weathermodule::SequenceOfTemperatureData";

    private static final char[] PLUGIN_VERSION = {2, 0, 0, 0};     
    private static final SequenceOfTemperatureDataTypeSupport _singleton
    = new SequenceOfTemperatureDataTypeSupport();
    ...
    */
    public static SequenceOfTemperatureDataTypeSupport get_instance() {
        return _singleton;
    }

    public static SequenceOfTemperatureDataTypeSupport getInstance() {
        return get_instance();
    }

    public static TypeCode getTypeCode(){
        return SequenceOfTemperatureDataTypeCode.VALUE;
    }

    public Object create_data() {
        return SequenceOfTemperatureData.create();
    }
    ...
    public Object create_key() {
        return new SequenceOfTemperatureData();
    }
    ...
    public Class get_type() {
        return SequenceOfTemperatureData.class;
    }
    ...
    * <code>this</code> is not a <code>SequenceOfTemperatureData</code>
    * type.
    */
    public Object copy_data(Object destination, Object source) {

        SequenceOfTemperatureData typedDst = (SequenceOfTemperatureData) destination;
        SequenceOfTemperatureData typedSrc = (SequenceOfTemperatureData) source;
    ...
    public long get_serialized_sample_max_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, ((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthTemperatureData.VALUE)));
        if (include_encapsulation) {
    ...
    public long get_serialized_sample_min_size(Object endpoint_data,boolean include_encapsulation,short encapsulation_id,long currentAlignment) {
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureDataTypeSupport.get_instance().get_sequence_max_size_serialized(endpoint_data, currentAlignment, 0);
    ...
    public long get_serialized_sample_size(
        ...
        Object sample) 
    {
        SequenceOfTemperatureData typedSrc = (SequenceOfTemperatureData) sample;
        long origAlignment = currentAlignment;
        long encapsulation_size = currentAlignment;
        ...
        currentAlignment += org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureDataTypeSupport.get_instance().get_sequence_serialized_size(
    ...
    short encapsulation_id, boolean serialize_sample, Object endpoint_plugin_qos) {
        ...
        if(serialize_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureDataTypeSupport.get_instance().serialize_sequence(endpoint_data, dst, typedSrc.userData,((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthTemperatureData.VALUE)), endpoint_plugin_qos);
        }
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if(deserialize_sample) {
            ...
            SequenceOfTemperatureData typedDst = (SequenceOfTemperatureData) dst;
            org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureDataTypeSupport.get_instance().deserialize_sequence(endpoint_data, typedDst.userData, src, ((org.openfmb.model.dds.rti.openfmb.weathermodule.MaxLengthTemperatureData.VALUE)), endpoint_plugin_qos);            
        }
        if (deserialize_encapsulation) {
    ...
    Object endpoint_plugin_qos)
    {
        ...
        if (skip_sample) {
            ...
            org.openfmb.model.dds.rti.openfmb.weathermodule.TemperatureDataTypeSupport.get_instance().skip_sequence(endpoint_data, src, endpoint_plugin_qos);
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
            ...
            SequenceOfTemperatureData typedDst = (SequenceOfTemperatureData) sample;
    ...
    protected SequenceOfTemperatureDataTypeSupport() {

        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,SequenceOfTemperatureDataTypeCode.VALUE,SequenceOfTemperatureData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);

    }

    protected SequenceOfTemperatureDataTypeSupport (boolean enableKeySupport) {

        super(TYPE_NAME, enableKeySupport,SequenceOfTemperatureDataTypeCode.VALUE,SequenceOfTemperatureData.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
