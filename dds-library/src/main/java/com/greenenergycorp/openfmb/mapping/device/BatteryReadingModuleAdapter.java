...
public class BatteryReadingModuleAdapter implements DeviceAdapter {

    private final BatteryReadingModuleDataWriter writer;
    private final String logicalDeviceId;
    private final BatterySystem deviceDescription;

    public BatteryReadingModuleAdapter(BatteryReadingModuleDataWriter writer, String logicalDeviceId, BatterySystem deviceDescription) {
        this.writer = writer;
    ...
    public void update(Map<ReadingId, MeasValue> readingValues, Map<String, MeasValue> keyValues) {
        ...
        final BatteryReadingModule message = mapToStruct(readingValues, keyValues);
        if (message != null) {
    ...
    public BatteryReadingModule mapToStruct(Map<ReadingId, MeasValue> readingValues, Map<String, MeasValue> keyValues) {

        if (readingValues != null && !readingValues.isEmpty()) {

            final BatteryReadingModule module = new BatteryReadingModule();
