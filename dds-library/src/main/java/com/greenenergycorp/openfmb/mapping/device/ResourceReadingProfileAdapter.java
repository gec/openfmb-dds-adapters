...
public class ResourceReadingProfileAdapter implements DeviceAdapter {

    private final ResourceReadingProfileDataWriter writer;
    private final String messageId;
    private final Meter deviceDescription;

    public ResourceReadingProfileAdapter(ResourceReadingProfileDataWriter writer, String messageId, Meter deviceDescription) {
        this.writer = writer;
    ...
    public void update(Map<ReadingId, MeasValue> readingValues, Map<String, MeasValue> keyValues) {
        ...
        final ResourceReadingProfile message = mapToStruct(readingValues, keyValues);
        if (message != null) {
            writer.write(message, InstanceHandle_t.HANDLE_NIL);
        }
    }

    public ResourceReadingProfile mapToStruct(Map<ReadingId, MeasValue> readingValues, Map<String, MeasValue> keyValues) {
        ...
        if (readingValues != null && !readingValues.isEmpty()) {
            ...
            module.meter = deviceDescription;
