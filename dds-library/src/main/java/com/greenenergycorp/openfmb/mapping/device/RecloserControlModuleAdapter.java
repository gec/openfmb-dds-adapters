...
import org.openfmb.model.dds.rti.openfmb.reclosermodule.RecloserControlModule;

import java.io.IOException;
import java.util.List;
import java.util.Map;

public class RecloserControlModuleAdapter implements ControlAdapter {
    ...
    public RecloserControlModuleAdapter(TypedTopicSubscription<RecloserControlModule> subscription, Map<String, String> deviceIdToAdapterName, ControlMapping handlerMap) {
        this.subscription = subscription;
        this.deviceIdToAdapterName = deviceIdToAdapterName;
        this.handlerMap = handlerMap;
    }

    public static RecloserControlModuleAdapter build(final DataReader reader, final Map<String, String> deviceIdToAdapterName, final ControlMapping handlerMap) {
        ...
        return new RecloserControlModuleAdapter(subscription, deviceIdToAdapterName, handlerMap);
    }
